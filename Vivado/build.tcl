...
#
# build.tcl: Tcl script for re-creating project 'LSM-Compactron3000'
#
# Generated by Vivado on Sun Oct 15 23:37:20 UTC 2023
...
#
#    "/home/azureuser/Projects/LSM-Compactron3000/Vivado/LSM-Compactron3000.srcs/sources_1/bd/dmaSystem/dmaSystem.bd"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/src/bd/dmaSystem.bd"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "[file normalize "$origin_dir/ip_repo"]"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "LSM-Compactron3000"
...
create_project ${_xil_proj_name_} $origin_dir/myproject -part xc7z010clg400-1
...
#set files [list \
# [file normalize "${origin_dir}/LSM-Compactron3000.srcs/sources_1/bd/dmaSystem/dmaSystem.bd" ]\
#]
...
#set file "dmaSystem/dmaSystem.bd"
...
#set_property -name "top" -value "inverter" -objects $obj
...
# Create block design
source $origin_dir/src/bd/dmaSystem.tcl
