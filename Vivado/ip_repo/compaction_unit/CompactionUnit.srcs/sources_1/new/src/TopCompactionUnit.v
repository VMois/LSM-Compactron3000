...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [9:0] _GEN_159 = {{6'd0}, _writeDataPtr_T_1}; // @[KvRingBuffer.scala 148:147]
  ...
  wire [9:0] _GEN_160 = {{9'd0}, metadataOffsetPtr}; // @[KvRingBuffer.scala 150:57]
  wire [9:0] writeFullPtr = _writeFullPtr_T_2 + _GEN_160; // @[KvRingBuffer.scala 150:57]
  ...
  wire [9:0] _readFullPtr_T = readPtr * 6'h26; // @[KvRingBuffer.scala 203:31]
  wire [9:0] _readFullPtr_T_2 = _readFullPtr_T + readValueChunkPtr; // @[KvRingBuffer.scala 203:40]
  wire [9:0] readFullPtr = _readFullPtr_T_2 + readKeyChunkPtr; // @[KvRingBuffer.scala 203:60]
  ...
  wire [9:0] _GEN_58 = _T_13 ? 10'h2 : readValueChunkPtr; // @[KvRingBuffer.scala 227:42 232:35]
  ...
  wire [3:0] _GEN_61 = keyLen == 32'h1 ? 4'ha : 4'h1; // @[KvRingBuffer.scala 240:38 243:37 248:37]
  ...
  wire [9:0] _GEN_64 = _T_13 ? {{6'd0}, _GEN_61} : readKeyChunkPtr; // @[KvRingBuffer.scala 239:42]
  wire [3:0] _GEN_65 = _T_13 ? _GEN_62 : _GEN_44; // @[KvRingBuffer.scala 239:42]
  wire [31:0] _T_25 = keyLen - 32'h1; // @[KvRingBuffer.scala 257:54]
  wire [31:0] _GEN_161 = {{22'd0}, readKeyChunkPtr}; // @[KvRingBuffer.scala 257:43]
  wire  _T_26 = _GEN_161 == _T_25; // @[KvRingBuffer.scala 257:43]
  wire [3:0] _GEN_66 = _GEN_161 == _T_25 ? 4'h6 : _GEN_44; // @[KvRingBuffer.scala 257:61 258:40]
  wire [9:0] _GEN_67 = _GEN_161 == _T_25 ? 10'h0 : readValueChunkPtr; // @[KvRingBuffer.scala 257:61 259:43]
  wire [9:0] _GEN_68 = _GEN_161 == _T_25 ? 10'ha : _nextVal_T_14; // @[KvRingBuffer.scala 257:61 260:41 262:41]
  ...
  wire [31:0] _GEN_163 = {{22'd0}, readValueChunkPtr}; // @[KvRingBuffer.scala 323:44]
  wire  _T_44 = _GEN_163 == _T_43; // @[KvRingBuffer.scala 323:44]
  wire [3:0] _GEN_98 = _GEN_163 == _T_43 ? 4'ha : _GEN_44; // @[KvRingBuffer.scala 323:64 324:40]
  wire [9:0] _GEN_99 = _GEN_163 == _T_43 ? readValueChunkPtr : _nextVal_T_17; // @[KvRingBuffer.scala 323:64 326:43]
  ...
  assign io_status_halfFull = distanceBetweenPtrs >= 4'h4 | io_status_full; // @[KvRingBuffer.scala 379:64]
  always @(posedge clock) begin
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [3:0] _writeDataPtr_T_1 = io_isInputKey ? 4'h2 : 4'ha; // @[KvRingBuffer.scala 148:60]
  wire [9:0] _writeDataPtr_T_2 = io_isInputKey ? writeKeyChunkPtr : writeValueChunkPtr; // @[KvRingBuffer.scala 148:152]
  wire [9:0] _GEN_189 = {{6'd0}, _writeDataPtr_T_1}; // @[KvRingBuffer.scala 148:147]
  wire [9:0] _writeDataPtr_T_4 = _GEN_189 + _writeDataPtr_T_2; // @[KvRingBuffer.scala 148:147]
  wire [9:0] writeDataPtr = inputStateReg == 2'h0 ? _writeDataPtr_T_4 : 10'h0; // @[KvRingBuffer.scala 148:27]
  wire  metadataOffsetPtr = inputStateReg == 2'h2; // @[KvRingBuffer.scala 149:47]
  wire [9:0] _writeFullPtr_T = writePtr * 6'h26; // @[KvRingBuffer.scala 150:33]
  wire [9:0] _writeFullPtr_T_2 = _writeFullPtr_T + writeDataPtr; // @[KvRingBuffer.scala 150:42]
  wire [9:0] _GEN_190 = {{9'd0}, metadataOffsetPtr}; // @[KvRingBuffer.scala 150:57]
  wire [9:0] writeFullPtr = _writeFullPtr_T_2 + _GEN_190; // @[KvRingBuffer.scala 150:57]
  wire  _T = inputStateReg == 2'h1; // @[KvRingBuffer.scala 152:41]
  wire  _T_7 = ~fullReg; // @[KvRingBuffer.scala 158:34]
  wire [1:0] _GEN_11 = io_lastInput ? 2'h1 : inputStateReg; // @[KvRingBuffer.scala 142:32 163:40 164:39]
  wire [31:0] _GEN_12 = io_lastInput ? {{22'd0}, writeKeyChunkPtr} : writeReg; // @[KvRingBuffer.scala 145:27 163:40 165:34]
  ...
  wire [3:0] _GEN_61 = keyLen == 32'h1 ? 4'ha : 4'h1; // @[KvRingBuffer.scala 240:38 243:37 248:37]
  wire [3:0] _GEN_62 = keyLen == 32'h1 ? 4'h6 : 4'h4; // @[KvRingBuffer.scala 240:38 245:36 249:36]
  wire [9:0] _GEN_64 = {{6'd0}, _GEN_61}; // @[KvRingBuffer.scala 239:42]
  wire [31:0] _T_25 = keyLen - 32'h1; // @[KvRingBuffer.scala 257:54]
  wire [31:0] _GEN_191 = {{22'd0}, readKeyChunkPtr}; // @[KvRingBuffer.scala 257:43]
  wire  _T_26 = _GEN_191 == _T_25; // @[KvRingBuffer.scala 257:43]
  wire [3:0] _GEN_66 = _GEN_191 == _T_25 ? 4'h6 : outputStateReg; // @[KvRingBuffer.scala 257:61 258:40]
  wire [9:0] _GEN_67 = _GEN_191 == _T_25 ? 10'h0 : readValueChunkPtr; // @[KvRingBuffer.scala 257:61 259:43]
  wire [9:0] _GEN_68 = _GEN_191 == _T_25 ? 10'ha : _nextVal_T_14; // @[KvRingBuffer.scala 257:61 260:41 262:41]
  wire [3:0] _GEN_69 = io_deq_ready ? _GEN_66 : 4'h5; // @[KvRingBuffer.scala 256:36 267:36]
  wire [9:0] _GEN_70 = io_deq_ready ? _GEN_67 : readValueChunkPtr; // @[KvRingBuffer.scala 256:36]
  wire [9:0] _GEN_71 = io_deq_ready ? _GEN_68 : readKeyChunkPtr; // @[KvRingBuffer.scala 256:36]
  wire [31:0] _GEN_72 = io_deq_ready ? shadowReg : mem_data_data; // @[KvRingBuffer.scala 205:28 256:36 266:31]
  ...
  wire [31:0] _T_43 = valueLen - 32'h1; // @[KvRingBuffer.scala 323:57]
  wire [31:0] _GEN_193 = {{22'd0}, readValueChunkPtr}; // @[KvRingBuffer.scala 323:44]
  wire  _T_44 = _GEN_193 == _T_43; // @[KvRingBuffer.scala 323:44]
  wire [3:0] _GEN_98 = _GEN_193 == _T_43 ? 4'ha : outputStateReg; // @[KvRingBuffer.scala 323:64 324:40]
  wire [9:0] _GEN_99 = _GEN_193 == _T_43 ? readValueChunkPtr : _nextVal_T_17; // @[KvRingBuffer.scala 323:64 326:43]
  wire [3:0] _GEN_100 = io_deq_ready ? _GEN_98 : 4'h9; // @[KvRingBuffer.scala 322:36 331:36]
  wire [9:0] _GEN_101 = io_deq_ready ? _GEN_99 : readValueChunkPtr; // @[KvRingBuffer.scala 322:36]
  wire [3:0] _GEN_105 = _T_44 ? 4'ha : 4'h8; // @[KvRingBuffer.scala 338:60 339:36 341:36]
