...
`ifdef RANDOMIZE_REG_INIT
  ...
  reg [31:0] _RAND_16;
`endif // RANDOMIZE_REG_INIT
  reg [31:0] mem [0:41471]; // @[KvRingBuffer.scala 103:26]
  wire  mem_data_en; // @[KvRingBuffer.scala 103:26 204:{24,24} 103:26]
  reg [15:0] mem_data_addr; // @[KvRingBuffer.scala 103:26]
  wire [31:0] mem_data_data; // @[KvRingBuffer.scala 103:26]
  wire [31:0] mem_MPORT_data; // @[KvRingBuffer.scala 103:26 153:36]
  wire [15:0] mem_MPORT_addr; // @[KvRingBuffer.scala 103:26]
  wire  mem_MPORT_mask; // @[KvRingBuffer.scala 103:26 152:101]
  wire  mem_MPORT_en; // @[KvRingBuffer.scala 103:26 152:61]
  reg [4:0] readPtr; // @[KvRingBuffer.scala 94:29]
  wire [4:0] _nextVal_T_2 = readPtr + 5'h1; // @[KvRingBuffer.scala 95:63]
  wire [4:0] nextRead = readPtr == 5'h11 ? 5'h0 : _nextVal_T_2; // @[KvRingBuffer.scala 95:26]
  wire  moveOrResetRequested = io_control_moveReadPtr | io_control_resetRead; // @[KvRingBuffer.scala 195:55]
  wire  incrRead = moveOrResetRequested & io_control_moveReadPtr; // @[KvRingBuffer.scala 196:33]
  reg [4:0] writePtr; // @[KvRingBuffer.scala 94:29]
  wire [4:0] _nextVal_T_5 = writePtr + 5'h1; // @[KvRingBuffer.scala 95:63]
  wire [4:0] nextWrite = writePtr == 5'h11 ? 5'h0 : _nextVal_T_5; // @[KvRingBuffer.scala 95:26]
  ...
  wire [4:0] _distanceBetweenPtrs_T_2 = writePtr - readPtr; // @[KvRingBuffer.scala 134:65]
  wire [4:0] _distanceBetweenPtrs_T_4 = 5'h12 - readPtr; // @[KvRingBuffer.scala 134:84]
  wire [4:0] _distanceBetweenPtrs_T_6 = _distanceBetweenPtrs_T_4 + writePtr; // @[KvRingBuffer.scala 134:94]
  wire [4:0] distanceBetweenPtrs = writePtr >= readPtr ? _distanceBetweenPtrs_T_2 : _distanceBetweenPtrs_T_6; // @[KvRingBuffer.scala 134:34]
  ...
  wire [4:0] _writeDataPtr_T_1 = io_isInputKey ? 5'h8 : 5'h10; // @[KvRingBuffer.scala 148:60]
  wire [9:0] _writeDataPtr_T_2 = io_isInputKey ? writeKeyChunkPtr : writeValueChunkPtr; // @[KvRingBuffer.scala 148:152]
  wire [9:0] _GEN_159 = {{5'd0}, _writeDataPtr_T_1}; // @[KvRingBuffer.scala 148:147]
  wire [9:0] _writeDataPtr_T_4 = _GEN_159 + _writeDataPtr_T_2; // @[KvRingBuffer.scala 148:147]
  ...
  wire [11:0] _writeFullPtr_T = writePtr * 7'h48; // @[KvRingBuffer.scala 150:33]
  wire [11:0] _GEN_160 = {{2'd0}, writeDataPtr}; // @[KvRingBuffer.scala 150:42]
  wire [11:0] _writeFullPtr_T_2 = _writeFullPtr_T + _GEN_160; // @[KvRingBuffer.scala 150:42]
  wire [11:0] _GEN_161 = {{11'd0}, metadataOffsetPtr}; // @[KvRingBuffer.scala 150:57]
  wire [11:0] writeFullPtr = _writeFullPtr_T_2 + _GEN_161; // @[KvRingBuffer.scala 150:57]
  ...
  wire  _GEN_43 = io_control_moveReadPtr ? nextRead == writePtr & ~writeIsIncoming : _GEN_39; // @[KvRingBuffer.scala 192:18 198:39]
  wire [3:0] _GEN_44 = moveOrResetRequested ? 4'h0 : outputStateReg; // @[KvRingBuffer.scala 196:33 197:24 143:33]
  wire  _GEN_46 = moveOrResetRequested ? _GEN_43 : _GEN_39; // @[KvRingBuffer.scala 196:33]
  wire [11:0] _readFullPtr_T = readPtr * 7'h48; // @[KvRingBuffer.scala 203:31]
  wire [11:0] _GEN_162 = {{2'd0}, readValueChunkPtr}; // @[KvRingBuffer.scala 203:40]
  wire [11:0] _readFullPtr_T_2 = _readFullPtr_T + _GEN_162; // @[KvRingBuffer.scala 203:40]
  wire [11:0] _GEN_163 = {{2'd0}, readKeyChunkPtr}; // @[KvRingBuffer.scala 203:60]
  wire [11:0] readFullPtr = _readFullPtr_T_2 + _GEN_163; // @[KvRingBuffer.scala 203:60]
  reg [31:0] shadowReg; // @[KvRingBuffer.scala 205:28]
  wire  _T_13 = ~moveOrResetRequested; // @[KvRingBuffer.scala 211:31]
  wire [31:0] _GEN_56 = _T_13 ? mem_data_data : keyLen; // @[KvRingBuffer.scala 227:42 228:24 127:25]
  wire [9:0] _GEN_57 = _T_13 ? 10'h0 : readKeyChunkPtr; // @[KvRingBuffer.scala 227:42 231:33]
  wire [9:0] _GEN_58 = _T_13 ? 10'h8 : readValueChunkPtr; // @[KvRingBuffer.scala 227:42 232:35]
  wire [3:0] _GEN_59 = _T_13 ? 4'h3 : _GEN_44; // @[KvRingBuffer.scala 227:42 233:32]
  wire [9:0] _GEN_60 = keyLen == 32'h1 ? 10'h0 : readValueChunkPtr; // @[KvRingBuffer.scala 240:38 242:39]
  wire [4:0] _GEN_61 = keyLen == 32'h1 ? 5'h10 : 5'h1; // @[KvRingBuffer.scala 240:38 243:37 248:37]
  wire [3:0] _GEN_62 = keyLen == 32'h1 ? 4'h6 : 4'h4; // @[KvRingBuffer.scala 240:38 245:36 249:36]
  wire [9:0] _GEN_63 = _T_13 ? _GEN_60 : readValueChunkPtr; // @[KvRingBuffer.scala 239:42]
  wire [9:0] _GEN_64 = _T_13 ? {{5'd0}, _GEN_61} : readKeyChunkPtr; // @[KvRingBuffer.scala 239:42]
  wire [3:0] _GEN_65 = _T_13 ? _GEN_62 : _GEN_44; // @[KvRingBuffer.scala 239:42]
  wire [31:0] _T_25 = keyLen - 32'h1; // @[KvRingBuffer.scala 257:54]
  wire [31:0] _GEN_164 = {{22'd0}, readKeyChunkPtr}; // @[KvRingBuffer.scala 257:43]
  wire  _T_26 = _GEN_164 == _T_25; // @[KvRingBuffer.scala 257:43]
  wire [3:0] _GEN_66 = _GEN_164 == _T_25 ? 4'h6 : _GEN_44; // @[KvRingBuffer.scala 257:61 258:40]
  wire [9:0] _GEN_67 = _GEN_164 == _T_25 ? 10'h0 : readValueChunkPtr; // @[KvRingBuffer.scala 257:61 259:43]
  wire [9:0] _GEN_68 = _GEN_164 == _T_25 ? 10'h10 : _nextVal_T_14; // @[KvRingBuffer.scala 257:61 260:41 262:41]
  wire [3:0] _GEN_69 = io_deq_ready ? _GEN_66 : 4'h5; // @[KvRingBuffer.scala 256:36 267:36]
  wire [9:0] _GEN_70 = io_deq_ready ? _GEN_67 : readValueChunkPtr; // @[KvRingBuffer.scala 256:36]
  wire [9:0] _GEN_71 = io_deq_ready ? _GEN_68 : readKeyChunkPtr; // @[KvRingBuffer.scala 256:36]
  wire [31:0] _GEN_72 = io_deq_ready ? shadowReg : mem_data_data; // @[KvRingBuffer.scala 205:28 256:36 266:31]
  wire [3:0] _GEN_73 = _T_13 ? _GEN_69 : _GEN_44; // @[KvRingBuffer.scala 255:42]
  wire [9:0] _GEN_74 = _T_13 ? _GEN_70 : readValueChunkPtr; // @[KvRingBuffer.scala 255:42]
  wire [9:0] _GEN_75 = _T_13 ? _GEN_71 : readKeyChunkPtr; // @[KvRingBuffer.scala 255:42]
  wire [31:0] _GEN_76 = _T_13 ? _GEN_72 : shadowReg; // @[KvRingBuffer.scala 205:28 255:42]
  wire  _T_29 = io_deq_ready & _T_13; // @[KvRingBuffer.scala 273:31]
  wire [3:0] _GEN_77 = _T_26 ? 4'h6 : 4'h4; // @[KvRingBuffer.scala 274:57 275:36 279:36]
  wire [3:0] _GEN_80 = io_deq_ready & _T_13 ? _GEN_77 : _GEN_44; // @[KvRingBuffer.scala 273:57]
  wire [9:0] _GEN_81 = io_deq_ready & _T_13 ? _GEN_67 : readValueChunkPtr; // @[KvRingBuffer.scala 273:57]
  wire [9:0] _GEN_82 = io_deq_ready & _T_13 ? _GEN_68 : readKeyChunkPtr; // @[KvRingBuffer.scala 273:57]
  wire [3:0] _GEN_83 = valueLen == 32'h1 ? 4'ha : 4'h8; // @[KvRingBuffer.scala 291:48 292:44 294:44]
  wire [9:0] _GEN_84 = valueLen == 32'h1 ? readValueChunkPtr : 10'h1; // @[KvRingBuffer.scala 291:48 295:47]
  wire [3:0] _GEN_85 = io_outputKeyOnly ? 4'h0 : _GEN_83; // @[KvRingBuffer.scala 288:44 289:40]
  wire [9:0] _GEN_86 = io_outputKeyOnly ? readValueChunkPtr : _GEN_84; // @[KvRingBuffer.scala 288:44]
  wire [3:0] _GEN_87 = io_deq_ready ? _GEN_85 : 4'h7; // @[KvRingBuffer.scala 287:36 300:36]
  wire [9:0] _GEN_88 = io_deq_ready ? _GEN_86 : readValueChunkPtr; // @[KvRingBuffer.scala 287:36]
  wire [3:0] _GEN_89 = _T_13 ? _GEN_87 : _GEN_44; // @[KvRingBuffer.scala 286:42]
  wire [9:0] _GEN_90 = _T_13 ? _GEN_88 : readValueChunkPtr; // @[KvRingBuffer.scala 286:42]
  wire [3:0] _GEN_96 = _T_29 ? _GEN_85 : _GEN_44; // @[KvRingBuffer.scala 306:57]
  wire [9:0] _GEN_97 = _T_29 ? _GEN_86 : readValueChunkPtr; // @[KvRingBuffer.scala 306:57]
  wire [31:0] _T_43 = valueLen - 32'h1; // @[KvRingBuffer.scala 323:57]
  wire [31:0] _GEN_166 = {{22'd0}, readValueChunkPtr}; // @[KvRingBuffer.scala 323:44]
  wire  _T_44 = _GEN_166 == _T_43; // @[KvRingBuffer.scala 323:44]
  wire [3:0] _GEN_98 = _GEN_166 == _T_43 ? 4'ha : _GEN_44; // @[KvRingBuffer.scala 323:64 324:40]
  wire [9:0] _GEN_99 = _GEN_166 == _T_43 ? readValueChunkPtr : _nextVal_T_17; // @[KvRingBuffer.scala 323:64 326:43]
  wire [3:0] _GEN_100 = io_deq_ready ? _GEN_98 : 4'h9; // @[KvRingBuffer.scala 322:36 331:36]
  wire [9:0] _GEN_101 = io_deq_ready ? _GEN_99 : readValueChunkPtr; // @[KvRingBuffer.scala 322:36]
  wire [3:0] _GEN_102 = _T_13 ? _GEN_100 : _GEN_44; // @[KvRingBuffer.scala 321:42]
  wire [9:0] _GEN_103 = _T_13 ? _GEN_101 : readValueChunkPtr; // @[KvRingBuffer.scala 321:42]
  wire [3:0] _GEN_105 = _T_44 ? 4'ha : 4'h8; // @[KvRingBuffer.scala 338:60 339:36 341:36]
  wire [3:0] _GEN_107 = _T_29 ? _GEN_105 : _GEN_44; // @[KvRingBuffer.scala 337:57]
  wire [9:0] _GEN_108 = _T_29 ? _GEN_99 : readValueChunkPtr; // @[KvRingBuffer.scala 337:57]
  wire [3:0] _GEN_109 = io_deq_ready ? 4'h0 : 4'hb; // @[KvRingBuffer.scala 349:36 350:36 357:36]
  wire [3:0] _GEN_110 = _T_13 ? _GEN_109 : _GEN_44; // @[KvRingBuffer.scala 348:42]
  wire [3:0] _GEN_112 = _T_29 ? 4'h0 : _GEN_44; // @[KvRingBuffer.scala 363:57 364:32]
  wire [3:0] _GEN_113 = 4'hb == outputStateReg ? _GEN_112 : _GEN_44; // @[KvRingBuffer.scala 207:28]
  wire [3:0] _GEN_114 = 4'ha == outputStateReg ? _GEN_110 : _GEN_113; // @[KvRingBuffer.scala 207:28]
  wire [31:0] _GEN_115 = 4'ha == outputStateReg ? _GEN_76 : shadowReg; // @[KvRingBuffer.scala 205:28 207:28]
  wire [3:0] _GEN_116 = 4'h9 == outputStateReg ? _GEN_107 : _GEN_114; // @[KvRingBuffer.scala 207:28]
  wire [9:0] _GEN_117 = 4'h9 == outputStateReg ? _GEN_108 : readValueChunkPtr; // @[KvRingBuffer.scala 207:28]
  wire [31:0] _GEN_118 = 4'h9 == outputStateReg ? shadowReg : _GEN_115; // @[KvRingBuffer.scala 205:28 207:28]
  wire [3:0] _GEN_119 = 4'h8 == outputStateReg ? _GEN_102 : _GEN_116; // @[KvRingBuffer.scala 207:28]
  wire [9:0] _GEN_120 = 4'h8 == outputStateReg ? _GEN_103 : _GEN_117; // @[KvRingBuffer.scala 207:28]
  wire [31:0] _GEN_121 = 4'h8 == outputStateReg ? _GEN_76 : _GEN_118; // @[KvRingBuffer.scala 207:28]
  wire [3:0] _GEN_122 = 4'h7 == outputStateReg ? _GEN_96 : _GEN_119; // @[KvRingBuffer.scala 207:28]
  wire [9:0] _GEN_123 = 4'h7 == outputStateReg ? _GEN_97 : _GEN_120; // @[KvRingBuffer.scala 207:28]
  wire [31:0] _GEN_124 = 4'h7 == outputStateReg ? shadowReg : _GEN_121; // @[KvRingBuffer.scala 205:28 207:28]
  wire [3:0] _GEN_125 = 4'h6 == outputStateReg ? _GEN_89 : _GEN_122; // @[KvRingBuffer.scala 207:28]
  wire [9:0] _GEN_126 = 4'h6 == outputStateReg ? _GEN_90 : _GEN_123; // @[KvRingBuffer.scala 207:28]
  wire [31:0] _GEN_127 = 4'h6 == outputStateReg ? _GEN_76 : _GEN_124; // @[KvRingBuffer.scala 207:28]
  wire [3:0] _GEN_128 = 4'h5 == outputStateReg ? _GEN_80 : _GEN_125; // @[KvRingBuffer.scala 207:28]
  wire [9:0] _GEN_129 = 4'h5 == outputStateReg ? _GEN_81 : _GEN_126; // @[KvRingBuffer.scala 207:28]
  wire [9:0] _GEN_130 = 4'h5 == outputStateReg ? _GEN_82 : readKeyChunkPtr; // @[KvRingBuffer.scala 207:28]
  wire [31:0] _GEN_131 = 4'h5 == outputStateReg ? shadowReg : _GEN_127; // @[KvRingBuffer.scala 205:28 207:28]
  wire [3:0] _GEN_132 = 4'h4 == outputStateReg ? _GEN_73 : _GEN_128; // @[KvRingBuffer.scala 207:28]
  wire [9:0] _GEN_133 = 4'h4 == outputStateReg ? _GEN_74 : _GEN_129; // @[KvRingBuffer.scala 207:28]
  wire [9:0] _GEN_134 = 4'h4 == outputStateReg ? _GEN_75 : _GEN_130; // @[KvRingBuffer.scala 207:28]
  wire [31:0] _GEN_135 = 4'h4 == outputStateReg ? _GEN_76 : _GEN_131; // @[KvRingBuffer.scala 207:28]
  wire [31:0] _GEN_136 = 4'h3 == outputStateReg ? mem_data_data : valueLen; // @[KvRingBuffer.scala 207:28 238:22 128:27]
  wire [9:0] _GEN_137 = 4'h3 == outputStateReg ? _GEN_63 : _GEN_133; // @[KvRingBuffer.scala 207:28]
  wire [9:0] _GEN_138 = 4'h3 == outputStateReg ? _GEN_64 : _GEN_134; // @[KvRingBuffer.scala 207:28]
  wire [3:0] _GEN_139 = 4'h3 == outputStateReg ? _GEN_65 : _GEN_132; // @[KvRingBuffer.scala 207:28]
  wire [31:0] _GEN_140 = 4'h3 == outputStateReg ? shadowReg : _GEN_135; // @[KvRingBuffer.scala 205:28 207:28]
  wire  _io_deq_valid_T_1 = outputStateReg == 4'h6; // @[KvRingBuffer.scala 373:72]
  wire  _io_deq_valid_T_3 = outputStateReg == 4'h5; // @[KvRingBuffer.scala 373:111]
  wire  _io_deq_valid_T_4 = outputStateReg == 4'h4 | outputStateReg == 4'h6 | outputStateReg == 4'h5; // @[KvRingBuffer.scala 373:93]
  wire  _io_deq_valid_T_5 = outputStateReg == 4'h7; // @[KvRingBuffer.scala 373:148]
  wire  _io_deq_valid_T_9 = outputStateReg == 4'ha; // @[KvRingBuffer.scala 373:232]
  wire  _io_deq_valid_T_11 = outputStateReg == 4'h9; // @[KvRingBuffer.scala 373:273]
  wire  _io_deq_valid_T_13 = outputStateReg == 4'hb; // @[KvRingBuffer.scala 373:312]
  assign mem_data_en = 1'h1; // @[KvRingBuffer.scala 204:{24,24} 103:26]
  `ifndef RANDOMIZE_GARBAGE_ASSIGN
  assign mem_data_data = mem[mem_data_addr]; // @[KvRingBuffer.scala 103:26]
  `else
  assign mem_data_data = mem_data_addr >= 16'ha200 ? _RAND_2[31:0] : mem[mem_data_addr]; // @[KvRingBuffer.scala 103:26]
  `endif // RANDOMIZE_GARBAGE_ASSIGN
  ...
  assign io_enq_ready = _writeDataPtr_T & _T_7; // @[KvRingBuffer.scala 372:51]
  assign io_deq_valid = outputStateReg == 4'h4 | outputStateReg == 4'h6 | outputStateReg == 4'h5 | outputStateReg == 4'h7
     | outputStateReg == 4'h8 | outputStateReg == 4'ha | outputStateReg == 4'h9 | outputStateReg == 4'hb; // @[KvRingBuffer.scala 373:294]
  assign io_deq_bits = _io_deq_valid_T_3 | _io_deq_valid_T_5 | _io_deq_valid_T_11 | _io_deq_valid_T_13 ? shadowReg :
    mem_data_data; // @[KvRingBuffer.scala 374:23]
  assign io_lastOutput = _io_deq_valid_T_9 | _io_deq_valid_T_13 | (_io_deq_valid_T_1 | _io_deq_valid_T_5) &
    io_outputKeyOnly; // @[KvRingBuffer.scala 376:110]
  assign io_isOutputKey = _io_deq_valid_T_4 | _io_deq_valid_T_5; // @[KvRingBuffer.scala 375:132]
  assign io_status_empty = emptyReg; // @[KvRingBuffer.scala 377:21]
  assign io_status_full = fullReg; // @[KvRingBuffer.scala 378:20]
  assign io_status_halfFull = distanceBetweenPtrs >= 5'h9 | io_status_full; // @[KvRingBuffer.scala 379:64]
  always @(posedge clock) begin
    if (mem_data_en) begin
      mem_data_addr <= {{4'd0}, readFullPtr}; // @[KvRingBuffer.scala 204:24]
    end
    if (mem_MPORT_en & mem_MPORT_mask) begin
      mem[mem_MPORT_addr] <= mem_MPORT_data; // @[KvRingBuffer.scala 103:26]
    end
    if (reset) begin // @[KvRingBuffer.scala 94:29]
      readPtr <= 5'h0; // @[KvRingBuffer.scala 94:29]
    end else if (incrRead) begin // @[KvRingBuffer.scala 96:21]
      if (readPtr == 5'h11) begin // @[KvRingBuffer.scala 95:26]
        readPtr <= 5'h0;
      end else begin
    ...
    if (reset) begin // @[KvRingBuffer.scala 94:29]
      writePtr <= 5'h0; // @[KvRingBuffer.scala 94:29]
    end else if (incrWrite) begin // @[KvRingBuffer.scala 96:21]
      if (writePtr == 5'h11) begin // @[KvRingBuffer.scala 95:26]
        writePtr <= 5'h0;
      end else begin
    ...
    end else if (4'h0 == outputStateReg) begin // @[KvRingBuffer.scala 207:28]
      if (~emptyReg & ~moveOrResetRequested) begin // @[KvRingBuffer.scala 211:54]
        readKeyChunkPtr <= 10'h0; // @[KvRingBuffer.scala 212:33]
      end
    end else if (4'h1 == outputStateReg) begin // @[KvRingBuffer.scala 207:28]
      if (_T_13) begin // @[KvRingBuffer.scala 219:42]
        readKeyChunkPtr <= 10'h1; // @[KvRingBuffer.scala 222:33]
      end
    end else if (4'h2 == outputStateReg) begin // @[KvRingBuffer.scala 207:28]
      readKeyChunkPtr <= _GEN_57;
    end else begin
      readKeyChunkPtr <= _GEN_138;
    end
    if (reset) begin // @[KvRingBuffer.scala 94:29]
      readValueChunkPtr <= 10'h0; // @[KvRingBuffer.scala 94:29]
    end else if (4'h0 == outputStateReg) begin // @[KvRingBuffer.scala 207:28]
      if (~emptyReg & ~moveOrResetRequested) begin // @[KvRingBuffer.scala 211:54]
        readValueChunkPtr <= 10'h0; // @[KvRingBuffer.scala 213:35]
      end
    end else if (!(4'h1 == outputStateReg)) begin // @[KvRingBuffer.scala 207:28]
      if (4'h2 == outputStateReg) begin // @[KvRingBuffer.scala 207:28]
        readValueChunkPtr <= _GEN_58;
      end else begin
        readValueChunkPtr <= _GEN_137;
      end
    end
    if (reset) begin // @[KvRingBuffer.scala 127:25]
      keyLen <= 32'h0; // @[KvRingBuffer.scala 127:25]
    end else if (!(4'h0 == outputStateReg)) begin // @[KvRingBuffer.scala 207:28]
      if (!(4'h1 == outputStateReg)) begin // @[KvRingBuffer.scala 207:28]
        if (4'h2 == outputStateReg) begin // @[KvRingBuffer.scala 207:28]
          keyLen <= _GEN_56;
        end
      end
    ...
    emptyReg <= reset | _GEN_46; // @[KvRingBuffer.scala 130:{27,27}]
    if (reset) begin // @[KvRingBuffer.scala 131:26]
      fullReg <= 1'h0; // @[KvRingBuffer.scala 131:26]
    end else if (!(2'h0 == inputStateReg)) begin // @[KvRingBuffer.scala 156:27]
      if (!(2'h1 == inputStateReg)) begin // @[KvRingBuffer.scala 156:27]
        if (2'h2 == inputStateReg) begin // @[KvRingBuffer.scala 156:27]
          fullReg <= nextWrite == readPtr; // @[KvRingBuffer.scala 179:21]
        end
      end
    end
    if (reset) begin // @[KvRingBuffer.scala 143:33]
      ...
      if (~emptyReg & ~moveOrResetRequested) begin // @[KvRingBuffer.scala 211:54]
        outputStateReg <= 4'h1; // @[KvRingBuffer.scala 214:32]
      end else begin
        outputStateReg <= _GEN_44;
      end
    end else if (4'h1 == outputStateReg) begin // @[KvRingBuffer.scala 207:28]
      if (_T_13) begin // @[KvRingBuffer.scala 219:42]
        outputStateReg <= 4'h2; // @[KvRingBuffer.scala 220:32]
      end else begin
        outputStateReg <= _GEN_44;
      end
    end else if (4'h2 == outputStateReg) begin // @[KvRingBuffer.scala 207:28]
      outputStateReg <= _GEN_59;
    end else begin
      outputStateReg <= _GEN_139;
    end
    ...
    if (reset) begin // @[KvRingBuffer.scala 205:28]
      shadowReg <= 32'h0; // @[KvRingBuffer.scala 205:28]
    end else if (!(4'h0 == outputStateReg)) begin // @[KvRingBuffer.scala 207:28]
      if (!(4'h1 == outputStateReg)) begin // @[KvRingBuffer.scala 207:28]
        if (!(4'h2 == outputStateReg)) begin // @[KvRingBuffer.scala 207:28]
          shadowReg <= _GEN_140;
...
`ifdef RANDOMIZE_MEM_INIT
  _RAND_0 = {1{`RANDOM}};
  for (initvar = 0; initvar < 41472; initvar = initvar+1)
    mem[initvar] = _RAND_0[31:0];
`endif // RANDOMIZE_MEM_INIT
`ifdef RANDOMIZE_REG_INIT
  _RAND_1 = {1{`RANDOM}};
  mem_data_addr = _RAND_1[15:0];
  _RAND_3 = {1{`RANDOM}};
  readPtr = _RAND_3[4:0];
  _RAND_4 = {1{`RANDOM}};
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [4:0] nextRead = readPtr == 5'h11 ? 5'h0 : _nextVal_T_2; // @[KvRingBuffer.scala 95:26]
  reg [3:0] outputStateReg; // @[KvRingBuffer.scala 143:33]
  wire  _GEN_123 = 4'ha == outputStateReg ? io_deq_ready : 4'hb == outputStateReg & io_deq_ready; // @[KvRingBuffer.scala 207:28]
  wire  _GEN_128 = 4'h9 == outputStateReg ? 1'h0 : _GEN_123; // @[KvRingBuffer.scala 207:28]
  wire  _GEN_134 = 4'h8 == outputStateReg ? 1'h0 : _GEN_128; // @[KvRingBuffer.scala 207:28]
  wire  _GEN_139 = 4'h7 == outputStateReg ? 1'h0 : _GEN_134; // @[KvRingBuffer.scala 207:28]
  wire  _GEN_144 = 4'h6 == outputStateReg ? 1'h0 : _GEN_139; // @[KvRingBuffer.scala 207:28]
  wire  _GEN_150 = 4'h5 == outputStateReg ? 1'h0 : _GEN_144; // @[KvRingBuffer.scala 207:28]
  wire  _GEN_156 = 4'h4 == outputStateReg ? 1'h0 : _GEN_150; // @[KvRingBuffer.scala 207:28]
  wire  _GEN_163 = 4'h3 == outputStateReg ? 1'h0 : _GEN_156; // @[KvRingBuffer.scala 207:28]
  wire  _GEN_171 = 4'h2 == outputStateReg ? 1'h0 : _GEN_163; // @[KvRingBuffer.scala 207:28]
  wire  _GEN_179 = 4'h1 == outputStateReg ? 1'h0 : _GEN_171; // @[KvRingBuffer.scala 207:28]
  wire  incrRead = 4'h0 == outputStateReg ? 1'h0 : _GEN_179; // @[KvRingBuffer.scala 207:28]
  reg [4:0] writePtr; // @[KvRingBuffer.scala 94:29]
  wire [4:0] _nextVal_T_5 = writePtr + 5'h1; // @[KvRingBuffer.scala 95:63]
  wire [4:0] nextWrite = writePtr == 5'h11 ? 5'h0 : _nextVal_T_5; // @[KvRingBuffer.scala 95:26]
  reg [1:0] inputStateReg; // @[KvRingBuffer.scala 142:32]
  ...
  wire [4:0] _writeDataPtr_T_1 = io_isInputKey ? 5'h8 : 5'h10; // @[KvRingBuffer.scala 148:60]
  wire [9:0] _writeDataPtr_T_2 = io_isInputKey ? writeKeyChunkPtr : writeValueChunkPtr; // @[KvRingBuffer.scala 148:152]
  wire [9:0] _GEN_189 = {{5'd0}, _writeDataPtr_T_1}; // @[KvRingBuffer.scala 148:147]
  wire [9:0] _writeDataPtr_T_4 = _GEN_189 + _writeDataPtr_T_2; // @[KvRingBuffer.scala 148:147]
  wire [9:0] writeDataPtr = inputStateReg == 2'h0 ? _writeDataPtr_T_4 : 10'h0; // @[KvRingBuffer.scala 148:27]
  wire  metadataOffsetPtr = inputStateReg == 2'h2; // @[KvRingBuffer.scala 149:47]
  wire [11:0] _writeFullPtr_T = writePtr * 7'h48; // @[KvRingBuffer.scala 150:33]
  wire [11:0] _GEN_190 = {{2'd0}, writeDataPtr}; // @[KvRingBuffer.scala 150:42]
  wire [11:0] _writeFullPtr_T_2 = _writeFullPtr_T + _GEN_190; // @[KvRingBuffer.scala 150:42]
  wire [11:0] _GEN_191 = {{11'd0}, metadataOffsetPtr}; // @[KvRingBuffer.scala 150:57]
  wire [11:0] writeFullPtr = _writeFullPtr_T_2 + _GEN_191; // @[KvRingBuffer.scala 150:57]
  wire  _T = inputStateReg == 2'h1; // @[KvRingBuffer.scala 152:41]
  wire  _T_7 = ~fullReg; // @[KvRingBuffer.scala 158:34]
  wire [1:0] _GEN_11 = io_lastInput ? 2'h1 : inputStateReg; // @[KvRingBuffer.scala 142:32 163:40 164:39]
  wire [31:0] _GEN_12 = io_lastInput ? {{22'd0}, writeKeyChunkPtr} : writeReg; // @[KvRingBuffer.scala 145:27 163:40 165:34]
  ...
  wire  writeIsIncoming = _T | metadataOffsetPtr; // @[KvRingBuffer.scala 188:62]
  wire [11:0] _readFullPtr_T = readPtr * 7'h48; // @[KvRingBuffer.scala 203:31]
  wire [11:0] _GEN_192 = {{2'd0}, readValueChunkPtr}; // @[KvRingBuffer.scala 203:40]
  wire [11:0] _readFullPtr_T_2 = _readFullPtr_T + _GEN_192; // @[KvRingBuffer.scala 203:40]
  wire [11:0] _GEN_193 = {{2'd0}, readKeyChunkPtr}; // @[KvRingBuffer.scala 203:60]
  wire [11:0] readFullPtr = _readFullPtr_T_2 + _GEN_193; // @[KvRingBuffer.scala 203:60]
  reg [31:0] shadowReg; // @[KvRingBuffer.scala 205:28]
  wire [31:0] _GEN_56 = mem_data_data; // @[KvRingBuffer.scala 227:42 228:24 127:25]
  wire [9:0] _GEN_60 = keyLen == 32'h1 ? 10'h0 : readValueChunkPtr; // @[KvRingBuffer.scala 240:38 242:39]
  wire [4:0] _GEN_61 = keyLen == 32'h1 ? 5'h10 : 5'h1; // @[KvRingBuffer.scala 240:38 243:37 248:37]
  wire [3:0] _GEN_62 = keyLen == 32'h1 ? 4'h6 : 4'h4; // @[KvRingBuffer.scala 240:38 245:36 249:36]
  wire [9:0] _GEN_64 = {{5'd0}, _GEN_61}; // @[KvRingBuffer.scala 239:42]
  wire [31:0] _T_25 = keyLen - 32'h1; // @[KvRingBuffer.scala 257:54]
  wire [31:0] _GEN_194 = {{22'd0}, readKeyChunkPtr}; // @[KvRingBuffer.scala 257:43]
  wire  _T_26 = _GEN_194 == _T_25; // @[KvRingBuffer.scala 257:43]
  wire [3:0] _GEN_66 = _GEN_194 == _T_25 ? 4'h6 : outputStateReg; // @[KvRingBuffer.scala 257:61 258:40]
  wire [9:0] _GEN_67 = _GEN_194 == _T_25 ? 10'h0 : readValueChunkPtr; // @[KvRingBuffer.scala 257:61 259:43]
  wire [9:0] _GEN_68 = _GEN_194 == _T_25 ? 10'h10 : _nextVal_T_14; // @[KvRingBuffer.scala 257:61 260:41 262:41]
  wire [3:0] _GEN_69 = io_deq_ready ? _GEN_66 : 4'h5; // @[KvRingBuffer.scala 256:36 267:36]
  wire [9:0] _GEN_70 = io_deq_ready ? _GEN_67 : readValueChunkPtr; // @[KvRingBuffer.scala 256:36]
  wire [9:0] _GEN_71 = io_deq_ready ? _GEN_68 : readKeyChunkPtr; // @[KvRingBuffer.scala 256:36]
  wire [31:0] _GEN_72 = io_deq_ready ? shadowReg : mem_data_data; // @[KvRingBuffer.scala 205:28 256:36 266:31]
  wire [3:0] _GEN_77 = _T_26 ? 4'h6 : 4'h4; // @[KvRingBuffer.scala 274:57 275:36 279:36]
  wire [3:0] _GEN_80 = io_deq_ready ? _GEN_77 : outputStateReg; // @[KvRingBuffer.scala 273:57]
  wire [3:0] _GEN_83 = valueLen == 32'h1 ? 4'ha : 4'h8; // @[KvRingBuffer.scala 291:48 292:44 294:44]
  wire [9:0] _GEN_84 = valueLen == 32'h1 ? readValueChunkPtr : 10'h1; // @[KvRingBuffer.scala 291:48 295:47]
  wire [3:0] _GEN_87 = io_deq_ready ? _GEN_83 : 4'h7; // @[KvRingBuffer.scala 287:36 300:36]
  wire [9:0] _GEN_88 = io_deq_ready ? _GEN_84 : readValueChunkPtr; // @[KvRingBuffer.scala 287:36]
  wire [3:0] _GEN_96 = io_deq_ready ? _GEN_83 : outputStateReg; // @[KvRingBuffer.scala 306:57]
  wire [31:0] _T_43 = valueLen - 32'h1; // @[KvRingBuffer.scala 323:57]
  wire [31:0] _GEN_196 = {{22'd0}, readValueChunkPtr}; // @[KvRingBuffer.scala 323:44]
  wire  _T_44 = _GEN_196 == _T_43; // @[KvRingBuffer.scala 323:44]
  wire [3:0] _GEN_98 = _GEN_196 == _T_43 ? 4'ha : outputStateReg; // @[KvRingBuffer.scala 323:64 324:40]
  wire [9:0] _GEN_99 = _GEN_196 == _T_43 ? readValueChunkPtr : _nextVal_T_17; // @[KvRingBuffer.scala 323:64 326:43]
  wire [3:0] _GEN_100 = io_deq_ready ? _GEN_98 : 4'h9; // @[KvRingBuffer.scala 322:36 331:36]
  wire [9:0] _GEN_101 = io_deq_ready ? _GEN_99 : readValueChunkPtr; // @[KvRingBuffer.scala 322:36]
  wire [3:0] _GEN_105 = _T_44 ? 4'ha : 4'h8; // @[KvRingBuffer.scala 338:60 339:36 341:36]
  wire [3:0] _GEN_107 = io_deq_ready ? _GEN_105 : outputStateReg; // @[KvRingBuffer.scala 337:57]
  wire [3:0] _GEN_109 = io_deq_ready ? 4'h0 : 4'hb; // @[KvRingBuffer.scala 349:36 350:36 357:36]
  wire  _GEN_111 = io_deq_ready ? nextRead == writePtr & ~writeIsIncoming : _GEN_39; // @[KvRingBuffer.scala 192:18 349:36]
  wire [3:0] _GEN_116 = io_deq_ready ? 4'h0 : outputStateReg; // @[KvRingBuffer.scala 363:57 364:32]
  wire [3:0] _GEN_119 = 4'hb == outputStateReg ? _GEN_116 : outputStateReg; // @[KvRingBuffer.scala 207:28]
  wire  _GEN_121 = 4'hb == outputStateReg ? _GEN_111 : _GEN_39; // @[KvRingBuffer.scala 207:28]
  wire [3:0] _GEN_122 = 4'ha == outputStateReg ? _GEN_109 : _GEN_119; // @[KvRingBuffer.scala 207:28]
  wire  _GEN_124 = 4'ha == outputStateReg ? _GEN_111 : _GEN_121; // @[KvRingBuffer.scala 207:28]
  wire [31:0] _GEN_125 = 4'ha == outputStateReg ? _GEN_72 : shadowReg; // @[KvRingBuffer.scala 205:28 207:28]
  wire [3:0] _GEN_126 = 4'h9 == outputStateReg ? _GEN_107 : _GEN_122; // @[KvRingBuffer.scala 207:28]
  wire [9:0] _GEN_127 = 4'h9 == outputStateReg ? _GEN_101 : readValueChunkPtr; // @[KvRingBuffer.scala 207:28]
  wire  _GEN_129 = 4'h9 == outputStateReg ? _GEN_39 : _GEN_124; // @[KvRingBuffer.scala 207:28]
  wire [31:0] _GEN_130 = 4'h9 == outputStateReg ? shadowReg : _GEN_125; // @[KvRingBuffer.scala 205:28 207:28]
  wire [3:0] _GEN_131 = 4'h8 == outputStateReg ? _GEN_100 : _GEN_126; // @[KvRingBuffer.scala 207:28]
  wire [9:0] _GEN_132 = 4'h8 == outputStateReg ? _GEN_101 : _GEN_127; // @[KvRingBuffer.scala 207:28]
  wire [31:0] _GEN_133 = 4'h8 == outputStateReg ? _GEN_72 : _GEN_130; // @[KvRingBuffer.scala 207:28]
  wire  _GEN_135 = 4'h8 == outputStateReg ? _GEN_39 : _GEN_129; // @[KvRingBuffer.scala 207:28]
  wire [3:0] _GEN_136 = 4'h7 == outputStateReg ? _GEN_96 : _GEN_131; // @[KvRingBuffer.scala 207:28]
  wire [9:0] _GEN_137 = 4'h7 == outputStateReg ? _GEN_88 : _GEN_132; // @[KvRingBuffer.scala 207:28]
  wire [31:0] _GEN_138 = 4'h7 == outputStateReg ? shadowReg : _GEN_133; // @[KvRingBuffer.scala 205:28 207:28]
  wire  _GEN_140 = 4'h7 == outputStateReg ? _GEN_39 : _GEN_135; // @[KvRingBuffer.scala 207:28]
  wire [3:0] _GEN_141 = 4'h6 == outputStateReg ? _GEN_87 : _GEN_136; // @[KvRingBuffer.scala 207:28]
  wire [9:0] _GEN_142 = 4'h6 == outputStateReg ? _GEN_88 : _GEN_137; // @[KvRingBuffer.scala 207:28]
  wire [31:0] _GEN_143 = 4'h6 == outputStateReg ? _GEN_72 : _GEN_138; // @[KvRingBuffer.scala 207:28]
  wire  _GEN_145 = 4'h6 == outputStateReg ? _GEN_39 : _GEN_140; // @[KvRingBuffer.scala 207:28]
  wire [3:0] _GEN_146 = 4'h5 == outputStateReg ? _GEN_80 : _GEN_141; // @[KvRingBuffer.scala 207:28]
  wire [9:0] _GEN_147 = 4'h5 == outputStateReg ? _GEN_70 : _GEN_142; // @[KvRingBuffer.scala 207:28]
  wire [9:0] _GEN_148 = 4'h5 == outputStateReg ? _GEN_71 : readKeyChunkPtr; // @[KvRingBuffer.scala 207:28]
  wire [31:0] _GEN_149 = 4'h5 == outputStateReg ? shadowReg : _GEN_143; // @[KvRingBuffer.scala 205:28 207:28]
  wire  _GEN_151 = 4'h5 == outputStateReg ? _GEN_39 : _GEN_145; // @[KvRingBuffer.scala 207:28]
  wire [3:0] _GEN_152 = 4'h4 == outputStateReg ? _GEN_69 : _GEN_146; // @[KvRingBuffer.scala 207:28]
  wire [9:0] _GEN_153 = 4'h4 == outputStateReg ? _GEN_70 : _GEN_147; // @[KvRingBuffer.scala 207:28]
  wire [9:0] _GEN_154 = 4'h4 == outputStateReg ? _GEN_71 : _GEN_148; // @[KvRingBuffer.scala 207:28]
  wire [31:0] _GEN_155 = 4'h4 == outputStateReg ? _GEN_72 : _GEN_149; // @[KvRingBuffer.scala 207:28]
  wire  _GEN_157 = 4'h4 == outputStateReg ? _GEN_39 : _GEN_151; // @[KvRingBuffer.scala 207:28]
  wire [31:0] _GEN_158 = 4'h3 == outputStateReg ? mem_data_data : valueLen; // @[KvRingBuffer.scala 207:28 238:22 128:27]
  wire [9:0] _GEN_159 = 4'h3 == outputStateReg ? _GEN_60 : _GEN_153; // @[KvRingBuffer.scala 207:28]
  wire [9:0] _GEN_160 = 4'h3 == outputStateReg ? _GEN_64 : _GEN_154; // @[KvRingBuffer.scala 207:28]
  wire [3:0] _GEN_161 = 4'h3 == outputStateReg ? _GEN_62 : _GEN_152; // @[KvRingBuffer.scala 207:28]
  wire [31:0] _GEN_162 = 4'h3 == outputStateReg ? shadowReg : _GEN_155; // @[KvRingBuffer.scala 205:28 207:28]
  wire  _GEN_164 = 4'h3 == outputStateReg ? _GEN_39 : _GEN_157; // @[KvRingBuffer.scala 207:28]
  wire  _GEN_172 = 4'h2 == outputStateReg ? _GEN_39 : _GEN_164; // @[KvRingBuffer.scala 207:28]
  wire  _GEN_180 = 4'h1 == outputStateReg ? _GEN_39 : _GEN_172; // @[KvRingBuffer.scala 207:28]
  wire  _GEN_188 = 4'h0 == outputStateReg ? _GEN_39 : _GEN_180; // @[KvRingBuffer.scala 207:28]
  wire  _io_deq_valid_T_3 = outputStateReg == 4'h5; // @[KvRingBuffer.scala 373:111]
  wire  _io_deq_valid_T_5 = outputStateReg == 4'h7; // @[KvRingBuffer.scala 373:148]
  wire  _io_deq_valid_T_9 = outputStateReg == 4'ha; // @[KvRingBuffer.scala 373:232]
  wire  _io_deq_valid_T_11 = outputStateReg == 4'h9; // @[KvRingBuffer.scala 373:273]
  ...
  assign io_deq_bits = _io_deq_valid_T_3 | _io_deq_valid_T_5 | _io_deq_valid_T_11 | _io_deq_valid_T_13 ? shadowReg :
    mem_data_data; // @[KvRingBuffer.scala 374:23]
  assign io_lastOutput = _io_deq_valid_T_9 | _io_deq_valid_T_13; // @[KvRingBuffer.scala 376:61]
  assign io_metadataValid = outputStateReg == 4'h2 | outputStateReg == 4'h3; // @[KvRingBuffer.scala 381:61]
  assign io_status_empty = emptyReg; // @[KvRingBuffer.scala 377:21]
  always @(posedge clock) begin
    if (mem_data_en) begin
      mem_data_addr <= {{4'd0}, readFullPtr}; // @[KvRingBuffer.scala 204:24]
    ...
    if (reset) begin // @[KvRingBuffer.scala 143:33]
      ...
      if (~emptyReg) begin // @[KvRingBuffer.scala 211:54]
        outputStateReg <= 4'h1; // @[KvRingBuffer.scala 214:32]
      end
    end else if (4'h1 == outputStateReg) begin // @[KvRingBuffer.scala 207:28]
      outputStateReg <= 4'h2;
    ...
    if (reset) begin // @[KvRingBuffer.scala 94:29]
      ...
      if (4'h2 == outputStateReg) begin // @[KvRingBuffer.scala 207:28]
        readValueChunkPtr <= 10'h8;
      end else begin
        readValueChunkPtr <= _GEN_159;
      end
    end
    if (reset) begin // @[KvRingBuffer.scala 127:25]
      keyLen <= 32'h0; // @[KvRingBuffer.scala 127:25]
    ...
    emptyReg <= reset | _GEN_188; // @[KvRingBuffer.scala 130:{27,27}]
    if (reset) begin // @[KvRingBuffer.scala 131:26]
      fullReg <= 1'h0; // @[KvRingBuffer.scala 131:26]
    end else if (!(2'h0 == inputStateReg)) begin // @[KvRingBuffer.scala 156:27]
      if (!(2'h1 == inputStateReg)) begin // @[KvRingBuffer.scala 156:27]
...
module CompactionUnit(
  ...
  wire  encoder_clock; // @[CompactionUnit.scala 18:25]
  wire  encoder_reset; // @[CompactionUnit.scala 18:25]
  wire  encoder_io_control_lastDataIsProcessed; // @[CompactionUnit.scala 18:25]
  wire  encoder_io_input_deq_ready; // @[CompactionUnit.scala 18:25]
  wire  encoder_io_input_deq_valid; // @[CompactionUnit.scala 18:25]
  wire [31:0] encoder_io_input_deq_bits; // @[CompactionUnit.scala 18:25]
  wire  encoder_io_input_lastOutput; // @[CompactionUnit.scala 18:25]
  wire  encoder_io_input_metadataValid; // @[CompactionUnit.scala 18:25]
  wire [31:0] encoder_io_output_axi_m_tdata; // @[CompactionUnit.scala 18:25]
  wire  encoder_io_output_axi_m_tvalid; // @[CompactionUnit.scala 18:25]
  wire  encoder_io_output_axi_m_tready; // @[CompactionUnit.scala 18:25]
  wire  encoder_io_output_axi_m_tlast; // @[CompactionUnit.scala 18:25]
  wire  DummyDecoder_clock; // @[CompactionUnit.scala 20:15]
  wire  DummyDecoder_reset; // @[CompactionUnit.scala 20:15]
  wire [31:0] DummyDecoder_io_input_axi_s_tdata; // @[CompactionUnit.scala 20:15]
  wire  DummyDecoder_io_input_axi_s_tvalid; // @[CompactionUnit.scala 20:15]
  wire  DummyDecoder_io_input_axi_s_tready; // @[CompactionUnit.scala 20:15]
  wire  DummyDecoder_io_output_enq_ready; // @[CompactionUnit.scala 20:15]
  wire  DummyDecoder_io_output_enq_valid; // @[CompactionUnit.scala 20:15]
  wire [31:0] DummyDecoder_io_output_enq_bits; // @[CompactionUnit.scala 20:15]
  wire  DummyDecoder_io_output_lastInput; // @[CompactionUnit.scala 20:15]
  wire  DummyDecoder_io_output_isInputKey; // @[CompactionUnit.scala 20:15]
  wire  DummyDecoder_io_control_lastKvPairSeen; // @[CompactionUnit.scala 20:15]
  wire  DummyDecoder_1_clock; // @[CompactionUnit.scala 20:15]
  wire  DummyDecoder_1_reset; // @[CompactionUnit.scala 20:15]
  wire [31:0] DummyDecoder_1_io_input_axi_s_tdata; // @[CompactionUnit.scala 20:15]
  wire  DummyDecoder_1_io_input_axi_s_tvalid; // @[CompactionUnit.scala 20:15]
  wire  DummyDecoder_1_io_input_axi_s_tready; // @[CompactionUnit.scala 20:15]
  wire  DummyDecoder_1_io_output_enq_ready; // @[CompactionUnit.scala 20:15]
  wire  DummyDecoder_1_io_output_enq_valid; // @[CompactionUnit.scala 20:15]
  wire [31:0] DummyDecoder_1_io_output_enq_bits; // @[CompactionUnit.scala 20:15]
  wire  DummyDecoder_1_io_output_lastInput; // @[CompactionUnit.scala 20:15]
  wire  DummyDecoder_1_io_output_isInputKey; // @[CompactionUnit.scala 20:15]
  wire  DummyDecoder_1_io_control_lastKvPairSeen; // @[CompactionUnit.scala 20:15]
  wire  KVRingBuffer_clock; // @[CompactionUnit.scala 23:15]
  wire  KVRingBuffer_reset; // @[CompactionUnit.scala 23:15]
  wire  KVRingBuffer_io_enq_ready; // @[CompactionUnit.scala 23:15]
  wire  KVRingBuffer_io_enq_valid; // @[CompactionUnit.scala 23:15]
  wire [31:0] KVRingBuffer_io_enq_bits; // @[CompactionUnit.scala 23:15]
  wire  KVRingBuffer_io_lastInput; // @[CompactionUnit.scala 23:15]
  wire  KVRingBuffer_io_isInputKey; // @[CompactionUnit.scala 23:15]
  wire  KVRingBuffer_io_control_moveReadPtr; // @[CompactionUnit.scala 23:15]
  wire  KVRingBuffer_io_control_resetRead; // @[CompactionUnit.scala 23:15]
  wire  KVRingBuffer_io_deq_ready; // @[CompactionUnit.scala 23:15]
  wire  KVRingBuffer_io_deq_valid; // @[CompactionUnit.scala 23:15]
  wire [31:0] KVRingBuffer_io_deq_bits; // @[CompactionUnit.scala 23:15]
  wire  KVRingBuffer_io_outputKeyOnly; // @[CompactionUnit.scala 23:15]
  wire  KVRingBuffer_io_lastOutput; // @[CompactionUnit.scala 23:15]
  wire  KVRingBuffer_io_isOutputKey; // @[CompactionUnit.scala 23:15]
  wire  KVRingBuffer_io_status_empty; // @[CompactionUnit.scala 23:15]
  wire  KVRingBuffer_io_status_full; // @[CompactionUnit.scala 23:15]
  wire  KVRingBuffer_io_status_halfFull; // @[CompactionUnit.scala 23:15]
  wire  KVRingBuffer_1_clock; // @[CompactionUnit.scala 23:15]
  wire  KVRingBuffer_1_reset; // @[CompactionUnit.scala 23:15]
  wire  KVRingBuffer_1_io_enq_ready; // @[CompactionUnit.scala 23:15]
  wire  KVRingBuffer_1_io_enq_valid; // @[CompactionUnit.scala 23:15]
  wire [31:0] KVRingBuffer_1_io_enq_bits; // @[CompactionUnit.scala 23:15]
  wire  KVRingBuffer_1_io_lastInput; // @[CompactionUnit.scala 23:15]
  wire  KVRingBuffer_1_io_isInputKey; // @[CompactionUnit.scala 23:15]
  wire  KVRingBuffer_1_io_control_moveReadPtr; // @[CompactionUnit.scala 23:15]
  wire  KVRingBuffer_1_io_control_resetRead; // @[CompactionUnit.scala 23:15]
  wire  KVRingBuffer_1_io_deq_ready; // @[CompactionUnit.scala 23:15]
  wire  KVRingBuffer_1_io_deq_valid; // @[CompactionUnit.scala 23:15]
  wire [31:0] KVRingBuffer_1_io_deq_bits; // @[CompactionUnit.scala 23:15]
  wire  KVRingBuffer_1_io_outputKeyOnly; // @[CompactionUnit.scala 23:15]
  wire  KVRingBuffer_1_io_lastOutput; // @[CompactionUnit.scala 23:15]
  wire  KVRingBuffer_1_io_isOutputKey; // @[CompactionUnit.scala 23:15]
  wire  KVRingBuffer_1_io_status_empty; // @[CompactionUnit.scala 23:15]
  wire  KVRingBuffer_1_io_status_full; // @[CompactionUnit.scala 23:15]
  wire  KVRingBuffer_1_io_status_halfFull; // @[CompactionUnit.scala 23:15]
  wire  kvTransfer_clock; // @[CompactionUnit.scala 25:28]
  wire  kvTransfer_reset; // @[CompactionUnit.scala 25:28]
  wire  kvTransfer_io_enq_0_ready; // @[CompactionUnit.scala 25:28]
  wire  kvTransfer_io_enq_0_valid; // @[CompactionUnit.scala 25:28]
  wire [31:0] kvTransfer_io_enq_0_bits; // @[CompactionUnit.scala 25:28]
  wire  kvTransfer_io_enq_1_ready; // @[CompactionUnit.scala 25:28]
  wire  kvTransfer_io_enq_1_valid; // @[CompactionUnit.scala 25:28]
  wire [31:0] kvTransfer_io_enq_1_bits; // @[CompactionUnit.scala 25:28]
  wire  kvTransfer_io_deq_ready; // @[CompactionUnit.scala 25:28]
  wire  kvTransfer_io_deq_valid; // @[CompactionUnit.scala 25:28]
  wire [31:0] kvTransfer_io_deq_bits; // @[CompactionUnit.scala 25:28]
  wire  kvTransfer_io_deqKvPair_ready; // @[CompactionUnit.scala 25:28]
  wire  kvTransfer_io_deqKvPair_valid; // @[CompactionUnit.scala 25:28]
  wire [31:0] kvTransfer_io_deqKvPair_bits; // @[CompactionUnit.scala 25:28]
  wire  kvTransfer_io_lastInputs_0; // @[CompactionUnit.scala 25:28]
  wire  kvTransfer_io_lastInputs_1; // @[CompactionUnit.scala 25:28]
  wire  kvTransfer_io_isInputKey_0; // @[CompactionUnit.scala 25:28]
  wire  kvTransfer_io_isInputKey_1; // @[CompactionUnit.scala 25:28]
  wire [1:0] kvTransfer_io_control_command; // @[CompactionUnit.scala 25:28]
  wire  kvTransfer_io_control_stop; // @[CompactionUnit.scala 25:28]
  wire  kvTransfer_io_control_bufferInputSelect; // @[CompactionUnit.scala 25:28]
  wire [1:0] kvTransfer_io_control_mask; // @[CompactionUnit.scala 25:28]
  wire  kvTransfer_io_control_busy; // @[CompactionUnit.scala 25:28]
  wire  kvTransfer_io_bufferSelect; // @[CompactionUnit.scala 25:28]
  wire  kvTransfer_io_outputKeyOnly; // @[CompactionUnit.scala 25:28]
  wire  kvTransfer_io_incrKeyBufferPtr; // @[CompactionUnit.scala 25:28]
  wire  kvTransfer_io_clearKeyBuffer; // @[CompactionUnit.scala 25:28]
  wire  kvTransfer_io_lastOutput; // @[CompactionUnit.scala 25:28]
  wire  kvTransfer_io_resetBufferRead; // @[CompactionUnit.scala 25:28]
  wire  kvTransfer_io_isOutputKey; // @[CompactionUnit.scala 25:28]
  wire  keyBuffer_clock; // @[CompactionUnit.scala 26:27]
  wire  keyBuffer_reset; // @[CompactionUnit.scala 26:27]
  wire  keyBuffer_io_enq_ready; // @[CompactionUnit.scala 26:27]
  wire  keyBuffer_io_enq_valid; // @[CompactionUnit.scala 26:27]
  wire [31:0] keyBuffer_io_enq_bits; // @[CompactionUnit.scala 26:27]
  wire  keyBuffer_io_deq_ready; // @[CompactionUnit.scala 26:27]
  wire  keyBuffer_io_deq_valid; // @[CompactionUnit.scala 26:27]
  wire [31:0] keyBuffer_io_deq_bits; // @[CompactionUnit.scala 26:27]
  wire  keyBuffer_io_bufferInputSelect; // @[CompactionUnit.scala 26:27]
  wire  keyBuffer_io_incrWritePtr; // @[CompactionUnit.scala 26:27]
  wire  keyBuffer_io_clearBuffer; // @[CompactionUnit.scala 26:27]
  wire  keyBuffer_io_lastInput; // @[CompactionUnit.scala 26:27]
  wire  keyBuffer_io_bufferOutputSelect; // @[CompactionUnit.scala 26:27]
  wire  keyBuffer_io_lastOutput; // @[CompactionUnit.scala 26:27]
  wire  merger_clock; // @[CompactionUnit.scala 27:24]
  wire  merger_reset; // @[CompactionUnit.scala 27:24]
  wire  merger_io_enq_ready; // @[CompactionUnit.scala 27:24]
  wire  merger_io_enq_valid; // @[CompactionUnit.scala 27:24]
  wire [31:0] merger_io_enq_bits; // @[CompactionUnit.scala 27:24]
  wire  merger_io_bufferInputSelect; // @[CompactionUnit.scala 27:24]
  wire  merger_io_lastInput; // @[CompactionUnit.scala 27:24]
  wire  merger_io_control_reset; // @[CompactionUnit.scala 27:24]
  wire [1:0] merger_io_control_mask; // @[CompactionUnit.scala 27:24]
  wire  merger_io_control_isResultValid; // @[CompactionUnit.scala 27:24]
  wire  merger_io_control_haveWinner; // @[CompactionUnit.scala 27:24]
  wire  merger_io_control_winnerIndex; // @[CompactionUnit.scala 27:24]
  wire  merger_io_control_nextKvPairsToLoad_0; // @[CompactionUnit.scala 27:24]
  wire  merger_io_control_nextKvPairsToLoad_1; // @[CompactionUnit.scala 27:24]
  wire  outputBuffer_clock; // @[CompactionUnit.scala 28:30]
  wire  outputBuffer_reset; // @[CompactionUnit.scala 28:30]
  wire  outputBuffer_io_enq_ready; // @[CompactionUnit.scala 28:30]
  wire  outputBuffer_io_enq_valid; // @[CompactionUnit.scala 28:30]
  wire [31:0] outputBuffer_io_enq_bits; // @[CompactionUnit.scala 28:30]
  wire  outputBuffer_io_lastInput; // @[CompactionUnit.scala 28:30]
  wire  outputBuffer_io_isInputKey; // @[CompactionUnit.scala 28:30]
  wire  outputBuffer_io_deq_ready; // @[CompactionUnit.scala 28:30]
  wire  outputBuffer_io_deq_valid; // @[CompactionUnit.scala 28:30]
  wire [31:0] outputBuffer_io_deq_bits; // @[CompactionUnit.scala 28:30]
  wire  outputBuffer_io_lastOutput; // @[CompactionUnit.scala 28:30]
  wire  outputBuffer_io_metadataValid; // @[CompactionUnit.scala 28:30]
  wire  outputBuffer_io_status_empty; // @[CompactionUnit.scala 28:30]
  wire  controller_clock; // @[CompactionUnit.scala 29:28]
  wire  controller_reset; // @[CompactionUnit.scala 29:28]
  wire  controller_io_control_start; // @[CompactionUnit.scala 29:28]
  wire  controller_io_control_busy; // @[CompactionUnit.scala 29:28]
  wire  controller_io_decoders_0_lastSeen; // @[CompactionUnit.scala 29:28]
  wire  controller_io_decoders_1_lastSeen; // @[CompactionUnit.scala 29:28]
  wire  controller_io_inputBuffers_0_status_empty; // @[CompactionUnit.scala 29:28]
  wire  controller_io_inputBuffers_0_status_halfFull; // @[CompactionUnit.scala 29:28]
  wire  controller_io_inputBuffers_0_control_moveReadPtr; // @[CompactionUnit.scala 29:28]
  wire  controller_io_inputBuffers_1_status_empty; // @[CompactionUnit.scala 29:28]
  wire  controller_io_inputBuffers_1_status_halfFull; // @[CompactionUnit.scala 29:28]
  wire  controller_io_inputBuffers_1_control_moveReadPtr; // @[CompactionUnit.scala 29:28]
  wire  controller_io_outputBuffer_empty; // @[CompactionUnit.scala 29:28]
  wire [1:0] controller_io_kvTransfer_command; // @[CompactionUnit.scala 29:28]
  wire  controller_io_kvTransfer_stop; // @[CompactionUnit.scala 29:28]
  wire  controller_io_kvTransfer_bufferInputSelect; // @[CompactionUnit.scala 29:28]
  wire [1:0] controller_io_kvTransfer_mask; // @[CompactionUnit.scala 29:28]
  wire  controller_io_kvTransfer_busy; // @[CompactionUnit.scala 29:28]
  wire  controller_io_merger_reset; // @[CompactionUnit.scala 29:28]
  wire [1:0] controller_io_merger_mask; // @[CompactionUnit.scala 29:28]
  wire  controller_io_merger_isResultValid; // @[CompactionUnit.scala 29:28]
  wire  controller_io_merger_haveWinner; // @[CompactionUnit.scala 29:28]
  wire  controller_io_merger_winnerIndex; // @[CompactionUnit.scala 29:28]
  wire  controller_io_merger_nextKvPairsToLoad_0; // @[CompactionUnit.scala 29:28]
  wire  controller_io_merger_nextKvPairsToLoad_1; // @[CompactionUnit.scala 29:28]
  wire  controller_io_encoder_lastDataIsProcessed; // @[CompactionUnit.scala 29:28]
  DummyEncoder encoder ( // @[CompactionUnit.scala 18:25]
    .clock(encoder_clock),
    .reset(encoder_reset),
  ...
  DummyDecoder DummyDecoder ( // @[CompactionUnit.scala 20:15]
  ...
  DummyDecoder DummyDecoder_1 ( // @[CompactionUnit.scala 20:15]
  ...
  KVRingBuffer KVRingBuffer ( // @[CompactionUnit.scala 23:15]
  ...
  KVRingBuffer KVRingBuffer_1 ( // @[CompactionUnit.scala 23:15]
  ...
  TopKvTransfer kvTransfer ( // @[CompactionUnit.scala 25:28]
    .clock(kvTransfer_clock),
    .reset(kvTransfer_reset),
  ...
  KeyBuffer keyBuffer ( // @[CompactionUnit.scala 26:27]
  ...
  Merger merger ( // @[CompactionUnit.scala 27:24]
    .clock(merger_clock),
    .reset(merger_reset),
  ...
  KVRingBuffer_2 outputBuffer ( // @[CompactionUnit.scala 28:30]
  ...
  Controller controller ( // @[CompactionUnit.scala 29:28]
  ...
  assign io_control_busy = controller_io_control_busy; // @[CompactionUnit.scala 75:21]
  assign io_encoder_axi_m_tdata = encoder_io_output_axi_m_tdata; // @[CompactionUnit.scala 32:29]
  assign io_encoder_axi_m_tvalid = encoder_io_output_axi_m_tvalid; // @[CompactionUnit.scala 32:29]
  assign io_encoder_axi_m_tlast = encoder_io_output_axi_m_tlast; // @[CompactionUnit.scala 32:29]
  assign io_decoders_0_axi_s_tready = DummyDecoder_io_input_axi_s_tready; // @[CompactionUnit.scala 41:24]
  assign io_decoders_1_axi_s_tready = DummyDecoder_1_io_input_axi_s_tready; // @[CompactionUnit.scala 41:24]
  assign encoder_clock = clock;
  assign encoder_reset = reset;
  assign encoder_io_control_lastDataIsProcessed = controller_io_encoder_lastDataIsProcessed; // @[CompactionUnit.scala 115:47]
  assign encoder_io_input_deq_valid = outputBuffer_io_deq_valid; // @[CompactionUnit.scala 33:26]
  assign encoder_io_input_deq_bits = outputBuffer_io_deq_bits; // @[CompactionUnit.scala 33:26]
  assign encoder_io_input_lastOutput = outputBuffer_io_lastOutput; // @[CompactionUnit.scala 35:33]
  assign encoder_io_input_metadataValid = outputBuffer_io_metadataValid; // @[CompactionUnit.scala 36:36]
  assign encoder_io_output_axi_m_tready = io_encoder_axi_m_tready; // @[CompactionUnit.scala 32:29]
  assign DummyDecoder_clock = clock;
  assign DummyDecoder_reset = reset;
  assign DummyDecoder_io_input_axi_s_tdata = io_decoders_0_axi_s_tdata; // @[CompactionUnit.scala 41:24]
  assign DummyDecoder_io_input_axi_s_tvalid = io_decoders_0_axi_s_tvalid; // @[CompactionUnit.scala 41:24]
  assign DummyDecoder_io_output_enq_ready = KVRingBuffer_io_enq_ready; // @[CompactionUnit.scala 42:35]
  assign DummyDecoder_1_clock = clock;
  assign DummyDecoder_1_reset = reset;
  assign DummyDecoder_1_io_input_axi_s_tdata = io_decoders_1_axi_s_tdata; // @[CompactionUnit.scala 41:24]
  assign DummyDecoder_1_io_input_axi_s_tvalid = io_decoders_1_axi_s_tvalid; // @[CompactionUnit.scala 41:24]
  assign DummyDecoder_1_io_output_enq_ready = KVRingBuffer_1_io_enq_ready; // @[CompactionUnit.scala 42:35]
  assign KVRingBuffer_clock = clock;
  assign KVRingBuffer_reset = reset;
  assign KVRingBuffer_io_enq_valid = DummyDecoder_io_output_enq_valid; // @[CompactionUnit.scala 42:35]
  assign KVRingBuffer_io_enq_bits = DummyDecoder_io_output_enq_bits; // @[CompactionUnit.scala 42:35]
  assign KVRingBuffer_io_lastInput = DummyDecoder_io_output_lastInput; // @[CompactionUnit.scala 44:41]
  assign KVRingBuffer_io_isInputKey = DummyDecoder_io_output_isInputKey; // @[CompactionUnit.scala 43:42]
  assign KVRingBuffer_io_control_moveReadPtr = controller_io_inputBuffers_0_control_moveReadPtr; // @[CompactionUnit.scala 88:59]
  assign KVRingBuffer_io_control_resetRead = kvTransfer_io_resetBufferRead; // @[CompactionUnit.scala 49:39]
  assign KVRingBuffer_io_deq_ready = kvTransfer_io_enq_0_ready; // @[CompactionUnit.scala 53:30]
  assign KVRingBuffer_io_outputKeyOnly = kvTransfer_io_outputKeyOnly; // @[CompactionUnit.scala 50:37]
  assign KVRingBuffer_1_clock = clock;
  assign KVRingBuffer_1_reset = reset;
  assign KVRingBuffer_1_io_enq_valid = DummyDecoder_1_io_output_enq_valid; // @[CompactionUnit.scala 42:35]
  assign KVRingBuffer_1_io_enq_bits = DummyDecoder_1_io_output_enq_bits; // @[CompactionUnit.scala 42:35]
  assign KVRingBuffer_1_io_lastInput = DummyDecoder_1_io_output_lastInput; // @[CompactionUnit.scala 44:41]
  assign KVRingBuffer_1_io_isInputKey = DummyDecoder_1_io_output_isInputKey; // @[CompactionUnit.scala 43:42]
  assign KVRingBuffer_1_io_control_moveReadPtr = controller_io_inputBuffers_1_control_moveReadPtr; // @[CompactionUnit.scala 88:59]
  assign KVRingBuffer_1_io_control_resetRead = kvTransfer_io_resetBufferRead; // @[CompactionUnit.scala 49:39]
  assign KVRingBuffer_1_io_deq_ready = kvTransfer_io_enq_1_ready; // @[CompactionUnit.scala 53:30]
  assign KVRingBuffer_1_io_outputKeyOnly = kvTransfer_io_outputKeyOnly; // @[CompactionUnit.scala 50:37]
  assign kvTransfer_clock = clock;
  assign kvTransfer_reset = reset;
  assign kvTransfer_io_enq_0_valid = KVRingBuffer_io_deq_valid; // @[CompactionUnit.scala 53:30]
  assign kvTransfer_io_enq_0_bits = KVRingBuffer_io_deq_bits; // @[CompactionUnit.scala 53:30]
  assign kvTransfer_io_enq_1_valid = KVRingBuffer_1_io_deq_valid; // @[CompactionUnit.scala 53:30]
  assign kvTransfer_io_enq_1_bits = KVRingBuffer_1_io_deq_bits; // @[CompactionUnit.scala 53:30]
  assign kvTransfer_io_deq_ready = keyBuffer_io_enq_ready; // @[CompactionUnit.scala 57:22]
  assign kvTransfer_io_deqKvPair_ready = outputBuffer_io_enq_ready; // @[CompactionUnit.scala 69:25]
  assign kvTransfer_io_lastInputs_0 = KVRingBuffer_io_lastOutput; // @[CompactionUnit.scala 51:37]
  assign kvTransfer_io_lastInputs_1 = KVRingBuffer_1_io_lastOutput; // @[CompactionUnit.scala 51:37]
  assign kvTransfer_io_isInputKey_0 = KVRingBuffer_io_isOutputKey; // @[CompactionUnit.scala 52:37]
  assign kvTransfer_io_isInputKey_1 = KVRingBuffer_1_io_isOutputKey; // @[CompactionUnit.scala 52:37]
  assign kvTransfer_io_control_command = controller_io_kvTransfer_command; // @[CompactionUnit.scala 95:38]
  assign kvTransfer_io_control_stop = controller_io_kvTransfer_stop; // @[CompactionUnit.scala 94:35]
  assign kvTransfer_io_control_bufferInputSelect = controller_io_kvTransfer_bufferInputSelect; // @[CompactionUnit.scala 97:48]
  assign kvTransfer_io_control_mask = controller_io_kvTransfer_mask; // @[CompactionUnit.scala 96:35]
  assign keyBuffer_clock = clock;
  assign keyBuffer_reset = reset;
  assign keyBuffer_io_enq_valid = kvTransfer_io_deq_valid; // @[CompactionUnit.scala 57:22]
  assign keyBuffer_io_enq_bits = kvTransfer_io_deq_bits; // @[CompactionUnit.scala 57:22]
  assign keyBuffer_io_deq_ready = merger_io_enq_ready; // @[CompactionUnit.scala 64:19]
  assign keyBuffer_io_bufferInputSelect = kvTransfer_io_bufferSelect; // @[CompactionUnit.scala 58:36]
  assign keyBuffer_io_incrWritePtr = kvTransfer_io_incrKeyBufferPtr; // @[CompactionUnit.scala 59:31]
  assign keyBuffer_io_clearBuffer = kvTransfer_io_clearKeyBuffer; // @[CompactionUnit.scala 60:30]
  assign keyBuffer_io_lastInput = kvTransfer_io_lastOutput; // @[CompactionUnit.scala 61:28]
  assign merger_clock = clock;
  assign merger_reset = reset;
  assign merger_io_enq_valid = keyBuffer_io_deq_valid; // @[CompactionUnit.scala 64:19]
  assign merger_io_enq_bits = keyBuffer_io_deq_bits; // @[CompactionUnit.scala 64:19]
  assign merger_io_bufferInputSelect = keyBuffer_io_bufferOutputSelect; // @[CompactionUnit.scala 66:33]
  assign merger_io_lastInput = keyBuffer_io_lastOutput; // @[CompactionUnit.scala 65:25]
  assign merger_io_control_reset = controller_io_merger_reset; // @[CompactionUnit.scala 104:32]
  assign merger_io_control_mask = controller_io_merger_mask; // @[CompactionUnit.scala 105:31]
  assign outputBuffer_clock = clock;
  assign outputBuffer_reset = reset;
  assign outputBuffer_io_enq_valid = kvTransfer_io_deqKvPair_valid; // @[CompactionUnit.scala 69:25]
  assign outputBuffer_io_enq_bits = kvTransfer_io_deqKvPair_bits; // @[CompactionUnit.scala 69:25]
  assign outputBuffer_io_lastInput = kvTransfer_io_lastOutput; // @[CompactionUnit.scala 70:31]
  assign outputBuffer_io_isInputKey = kvTransfer_io_isOutputKey; // @[CompactionUnit.scala 71:32]
  assign outputBuffer_io_deq_ready = encoder_io_input_deq_ready; // @[CompactionUnit.scala 33:26]
  assign controller_clock = clock;
  assign controller_reset = reset;
  assign controller_io_control_start = io_control_start; // @[CompactionUnit.scala 74:33]
  assign controller_io_decoders_0_lastSeen = DummyDecoder_io_control_lastKvPairSeen; // @[CompactionUnit.scala 80:44]
  assign controller_io_decoders_1_lastSeen = DummyDecoder_1_io_control_lastKvPairSeen; // @[CompactionUnit.scala 80:44]
  assign controller_io_inputBuffers_0_status_empty = KVRingBuffer_io_status_empty; // @[CompactionUnit.scala 85:52]
  assign controller_io_inputBuffers_0_status_halfFull = KVRingBuffer_io_status_halfFull; // @[CompactionUnit.scala 87:55]
  assign controller_io_inputBuffers_1_status_empty = KVRingBuffer_1_io_status_empty; // @[CompactionUnit.scala 85:52]
  assign controller_io_inputBuffers_1_status_halfFull = KVRingBuffer_1_io_status_halfFull; // @[CompactionUnit.scala 87:55]
  assign controller_io_outputBuffer_empty = outputBuffer_io_status_empty; // @[CompactionUnit.scala 108:38]
  assign controller_io_kvTransfer_busy = kvTransfer_io_control_busy; // @[CompactionUnit.scala 93:35]
  assign controller_io_merger_isResultValid = merger_io_control_isResultValid; // @[CompactionUnit.scala 101:40]
  assign controller_io_merger_haveWinner = merger_io_control_haveWinner; // @[CompactionUnit.scala 100:37]
  assign controller_io_merger_winnerIndex = merger_io_control_winnerIndex; // @[CompactionUnit.scala 102:38]
  assign controller_io_merger_nextKvPairsToLoad_0 = merger_io_control_nextKvPairsToLoad_0; // @[CompactionUnit.scala 103:44]
  assign controller_io_merger_nextKvPairsToLoad_1 = merger_io_control_nextKvPairsToLoad_1; // @[CompactionUnit.scala 103:44]
endmodule
module TopCompactionUnit(
  ...
  wire  compactionUnit_io_control_busy; // @[CompactionUnit.scala 136:32]
  wire [31:0] compactionUnit_io_encoder_axi_m_tdata; // @[CompactionUnit.scala 136:32]
  wire  compactionUnit_io_encoder_axi_m_tvalid; // @[CompactionUnit.scala 136:32]
  wire  compactionUnit_io_encoder_axi_m_tready; // @[CompactionUnit.scala 136:32]
  wire  compactionUnit_io_encoder_axi_m_tlast; // @[CompactionUnit.scala 136:32]
  wire [31:0] compactionUnit_io_decoders_0_axi_s_tdata; // @[CompactionUnit.scala 136:32]
  wire  compactionUnit_io_decoders_0_axi_s_tvalid; // @[CompactionUnit.scala 136:32]
  wire  compactionUnit_io_decoders_0_axi_s_tready; // @[CompactionUnit.scala 136:32]
  wire [31:0] compactionUnit_io_decoders_1_axi_s_tdata; // @[CompactionUnit.scala 136:32]
  wire  compactionUnit_io_decoders_1_axi_s_tvalid; // @[CompactionUnit.scala 136:32]
  wire  compactionUnit_io_decoders_1_axi_s_tready; // @[CompactionUnit.scala 136:32]
  ...
  assign compactionUnit_io_encoder_axi_m_tready = io_encoder_axi_m_tready; // @[CompactionUnit.scala 139:31]
  assign compactionUnit_io_decoders_0_axi_s_tdata = io_decoders_0_axi_s_tdata; // @[CompactionUnit.scala 138:32]
  assign compactionUnit_io_decoders_0_axi_s_tvalid = io_decoders_0_axi_s_tvalid; // @[CompactionUnit.scala 138:32]
  assign compactionUnit_io_decoders_1_axi_s_tdata = io_decoders_1_axi_s_tdata; // @[CompactionUnit.scala 138:32]
  assign compactionUnit_io_decoders_1_axi_s_tvalid = io_decoders_1_axi_s_tvalid; // @[CompactionUnit.scala 138:32]
endmodule
