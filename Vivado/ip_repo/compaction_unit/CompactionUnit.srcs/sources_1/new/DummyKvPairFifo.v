...
`endif // RANDOMIZE_REG_INIT
  ...
  wire  mem_data_en; // @[KvRingBuffer.scala 172:{24,24} 84:{26,26}]
  ...
  wire  _GEN_126 = 4'ha == outputStateReg ? io_deq_ready : 4'hb == outputStateReg & io_deq_ready; // @[KvRingBuffer.scala 175:28]
  wire  _GEN_131 = 4'h9 == outputStateReg ? 1'h0 : _GEN_126; // @[KvRingBuffer.scala 175:28]
  wire  _GEN_137 = 4'h8 == outputStateReg ? 1'h0 : _GEN_131; // @[KvRingBuffer.scala 175:28]
  wire  _GEN_142 = 4'h7 == outputStateReg ? 1'h0 : _GEN_137; // @[KvRingBuffer.scala 175:28]
  wire  _GEN_147 = 4'h6 == outputStateReg ? 1'h0 : _GEN_142; // @[KvRingBuffer.scala 175:28]
  wire  _GEN_153 = 4'h5 == outputStateReg ? 1'h0 : _GEN_147; // @[KvRingBuffer.scala 175:28]
  wire  _GEN_159 = 4'h4 == outputStateReg ? 1'h0 : _GEN_153; // @[KvRingBuffer.scala 175:28]
  wire  _GEN_166 = 4'h3 == outputStateReg ? 1'h0 : _GEN_159; // @[KvRingBuffer.scala 175:28]
  wire  _GEN_174 = 4'h2 == outputStateReg ? 1'h0 : _GEN_166; // @[KvRingBuffer.scala 175:28]
  wire  _GEN_182 = 4'h1 == outputStateReg ? 1'h0 : _GEN_174; // @[KvRingBuffer.scala 175:28]
  wire  incrRead = 4'h0 == outputStateReg ? 1'h0 : _GEN_182; // @[KvRingBuffer.scala 175:28]
  ...
  wire  _GEN_25 = 2'h1 == inputStateReg ? 1'h0 : 2'h2 == inputStateReg; // @[KvRingBuffer.scala 131:27]
  wire  incrWrite = 2'h0 == inputStateReg ? 1'h0 : _GEN_25; // @[KvRingBuffer.scala 131:27]
  ...
  wire  _T_8 = ~fullReg; // @[KvRingBuffer.scala 133:34]
  wire [1:0] _GEN_6 = io_lastInput ? 2'h1 : inputStateReg; // @[KvRingBuffer.scala 121:32 138:40 139:39]
  wire [31:0] _GEN_7 = io_lastInput ? {{22'd0}, writeKeyChunkPtr} : writeReg; // @[KvRingBuffer.scala 124:27 138:40 140:34]
  wire  _GEN_16 = 2'h2 == inputStateReg ? 1'h0 : emptyReg; // @[KvRingBuffer.scala 131:27 152:22 111:27]
  wire  _GEN_24 = 2'h1 == inputStateReg ? emptyReg : _GEN_16; // @[KvRingBuffer.scala 111:27 131:27]
  wire  _GEN_33 = 2'h0 == inputStateReg ? emptyReg : _GEN_24; // @[KvRingBuffer.scala 111:27 131:27]
  wire [5:0] _readFullPtr_T = readPtr * 4'h8; // @[KvRingBuffer.scala 171:31]
  wire [9:0] _GEN_194 = {{4'd0}, _readFullPtr_T}; // @[KvRingBuffer.scala 171:40]
  wire [9:0] _readFullPtr_T_2 = _GEN_194 + readValueChunkPtr; // @[KvRingBuffer.scala 171:40]
  wire [9:0] readFullPtr = _readFullPtr_T_2 + readKeyChunkPtr; // @[KvRingBuffer.scala 171:60]
  reg [31:0] shadowReg; // @[KvRingBuffer.scala 173:28]
  wire [31:0] _GEN_48 = mem_data_data; // @[KvRingBuffer.scala 192:42 193:24 108:25]
  wire [9:0] _GEN_52 = keyLen == 32'h1 ? 10'h0 : readValueChunkPtr; // @[KvRingBuffer.scala 205:38 207:39]
  wire [2:0] _GEN_53 = keyLen == 32'h1 ? 3'h6 : 3'h1; // @[KvRingBuffer.scala 205:38 208:37 213:37]
  wire [3:0] _GEN_54 = keyLen == 32'h1 ? 4'h6 : 4'h4; // @[KvRingBuffer.scala 205:38 210:36 214:36]
  wire [9:0] _GEN_56 = {{7'd0}, _GEN_53}; // @[KvRingBuffer.scala 204:42]
  wire [31:0] _T_26 = keyLen - 32'h1; // @[KvRingBuffer.scala 222:54]
  wire [31:0] _GEN_195 = {{22'd0}, readKeyChunkPtr}; // @[KvRingBuffer.scala 222:43]
  wire  _T_27 = _GEN_195 == _T_26; // @[KvRingBuffer.scala 222:43]
  wire  _emptyReg_T = nextRead == writePtr; // @[KvRingBuffer.scala 224:46]
  wire [3:0] _GEN_58 = _GEN_195 == _T_26 ? 4'h6 : outputStateReg; // @[KvRingBuffer.scala 222:61 223:40]
  wire  _GEN_59 = _GEN_195 == _T_26 ? nextRead == writePtr : _GEN_33; // @[KvRingBuffer.scala 222:61 224:34]
  wire [9:0] _GEN_60 = _GEN_195 == _T_26 ? 10'h0 : readValueChunkPtr; // @[KvRingBuffer.scala 222:61 225:43]
  wire [9:0] _GEN_61 = _GEN_195 == _T_26 ? 10'h6 : _nextVal_T_14; // @[KvRingBuffer.scala 222:61 226:41 228:41]
  wire [3:0] _GEN_62 = io_deq_ready ? _GEN_58 : 4'h5; // @[KvRingBuffer.scala 221:36 233:36]
  wire  _GEN_63 = io_deq_ready ? _GEN_59 : _GEN_33; // @[KvRingBuffer.scala 221:36]
  wire [9:0] _GEN_64 = io_deq_ready ? _GEN_60 : readValueChunkPtr; // @[KvRingBuffer.scala 221:36]
  wire [9:0] _GEN_65 = io_deq_ready ? _GEN_61 : readKeyChunkPtr; // @[KvRingBuffer.scala 221:36]
  wire [31:0] _GEN_66 = io_deq_ready ? shadowReg : mem_data_data; // @[KvRingBuffer.scala 173:28 221:36 232:31]
  wire [3:0] _GEN_72 = _T_27 ? 4'h6 : 4'h4; // @[KvRingBuffer.scala 240:57 241:36 246:36]
  wire [3:0] _GEN_76 = io_deq_ready ? _GEN_72 : outputStateReg; // @[KvRingBuffer.scala 239:57]
  wire [3:0] _GEN_80 = valueLen == 32'h1 ? 4'ha : 4'h8; // @[KvRingBuffer.scala 258:48 259:44 261:44]
  wire [9:0] _GEN_81 = valueLen == 32'h1 ? readValueChunkPtr : 10'h1; // @[KvRingBuffer.scala 258:48 262:47]
  wire [3:0] _GEN_84 = io_deq_ready ? _GEN_80 : 4'h7; // @[KvRingBuffer.scala 254:36 267:36]
  wire [9:0] _GEN_85 = io_deq_ready ? _GEN_81 : readValueChunkPtr; // @[KvRingBuffer.scala 254:36]
  wire [3:0] _GEN_93 = io_deq_ready ? _GEN_80 : outputStateReg; // @[KvRingBuffer.scala 273:57]
  wire [31:0] _T_44 = valueLen - 32'h1; // @[KvRingBuffer.scala 290:57]
  wire [31:0] _GEN_197 = {{22'd0}, readValueChunkPtr}; // @[KvRingBuffer.scala 290:44]
  wire  _T_45 = _GEN_197 == _T_44; // @[KvRingBuffer.scala 290:44]
  wire [3:0] _GEN_95 = _GEN_197 == _T_44 ? 4'ha : outputStateReg; // @[KvRingBuffer.scala 290:64 291:40]
  wire  _GEN_96 = _GEN_197 == _T_44 ? _emptyReg_T : _GEN_33; // @[KvRingBuffer.scala 290:64 295:34]
  wire [9:0] _GEN_97 = _GEN_197 == _T_44 ? readValueChunkPtr : _nextVal_T_17; // @[KvRingBuffer.scala 290:64 297:43]
  wire [3:0] _GEN_98 = io_deq_ready ? _GEN_95 : 4'h9; // @[KvRingBuffer.scala 289:36 302:36]
  wire  _GEN_99 = io_deq_ready ? _GEN_96 : _GEN_33; // @[KvRingBuffer.scala 289:36]
  wire [9:0] _GEN_100 = io_deq_ready ? _GEN_97 : readValueChunkPtr; // @[KvRingBuffer.scala 289:36]
  wire [3:0] _GEN_105 = _T_45 ? 4'ha : 4'h8; // @[KvRingBuffer.scala 309:60 310:36 316:36]
  wire [3:0] _GEN_108 = io_deq_ready ? _GEN_105 : outputStateReg; // @[KvRingBuffer.scala 308:57]
  wire [3:0] _GEN_111 = io_deq_ready ? 4'h0 : 4'hb; // @[KvRingBuffer.scala 324:36 325:36 333:36]
  wire  _GEN_112 = io_deq_ready ? _emptyReg_T : _GEN_33; // @[KvRingBuffer.scala 324:36 326:30]
  wire [3:0] _GEN_118 = io_deq_ready ? 4'h0 : outputStateReg; // @[KvRingBuffer.scala 339:57 340:32]
  wire [3:0] _GEN_121 = 4'hb == outputStateReg ? _GEN_118 : outputStateReg; // @[KvRingBuffer.scala 175:28]
  wire  _GEN_122 = 4'hb == outputStateReg ? _GEN_112 : _GEN_33; // @[KvRingBuffer.scala 175:28]
  wire [3:0] _GEN_124 = 4'ha == outputStateReg ? _GEN_111 : _GEN_121; // @[KvRingBuffer.scala 175:28]
  wire  _GEN_125 = 4'ha == outputStateReg ? _GEN_112 : _GEN_122; // @[KvRingBuffer.scala 175:28]
  wire [31:0] _GEN_127 = 4'ha == outputStateReg ? _GEN_66 : shadowReg; // @[KvRingBuffer.scala 173:28 175:28]
  wire [3:0] _GEN_128 = 4'h9 == outputStateReg ? _GEN_108 : _GEN_124; // @[KvRingBuffer.scala 175:28]
  wire  _GEN_129 = 4'h9 == outputStateReg ? _GEN_99 : _GEN_125; // @[KvRingBuffer.scala 175:28]
  wire [9:0] _GEN_130 = 4'h9 == outputStateReg ? _GEN_100 : readValueChunkPtr; // @[KvRingBuffer.scala 175:28]
  wire [31:0] _GEN_132 = 4'h9 == outputStateReg ? shadowReg : _GEN_127; // @[KvRingBuffer.scala 173:28 175:28]
  wire [3:0] _GEN_133 = 4'h8 == outputStateReg ? _GEN_98 : _GEN_128; // @[KvRingBuffer.scala 175:28]
  wire  _GEN_134 = 4'h8 == outputStateReg ? _GEN_99 : _GEN_129; // @[KvRingBuffer.scala 175:28]
  wire [9:0] _GEN_135 = 4'h8 == outputStateReg ? _GEN_100 : _GEN_130; // @[KvRingBuffer.scala 175:28]
  wire [31:0] _GEN_136 = 4'h8 == outputStateReg ? _GEN_66 : _GEN_132; // @[KvRingBuffer.scala 175:28]
  wire [3:0] _GEN_138 = 4'h7 == outputStateReg ? _GEN_93 : _GEN_133; // @[KvRingBuffer.scala 175:28]
  wire [9:0] _GEN_139 = 4'h7 == outputStateReg ? _GEN_85 : _GEN_135; // @[KvRingBuffer.scala 175:28]
  wire  _GEN_140 = 4'h7 == outputStateReg ? _GEN_33 : _GEN_134; // @[KvRingBuffer.scala 175:28]
  wire [31:0] _GEN_141 = 4'h7 == outputStateReg ? shadowReg : _GEN_136; // @[KvRingBuffer.scala 173:28 175:28]
  wire [3:0] _GEN_143 = 4'h6 == outputStateReg ? _GEN_84 : _GEN_138; // @[KvRingBuffer.scala 175:28]
  wire [9:0] _GEN_144 = 4'h6 == outputStateReg ? _GEN_85 : _GEN_139; // @[KvRingBuffer.scala 175:28]
  wire [31:0] _GEN_145 = 4'h6 == outputStateReg ? _GEN_66 : _GEN_141; // @[KvRingBuffer.scala 175:28]
  wire  _GEN_146 = 4'h6 == outputStateReg ? _GEN_33 : _GEN_140; // @[KvRingBuffer.scala 175:28]
  wire [3:0] _GEN_148 = 4'h5 == outputStateReg ? _GEN_76 : _GEN_143; // @[KvRingBuffer.scala 175:28]
  wire  _GEN_149 = 4'h5 == outputStateReg ? _GEN_63 : _GEN_146; // @[KvRingBuffer.scala 175:28]
  wire [9:0] _GEN_150 = 4'h5 == outputStateReg ? _GEN_64 : _GEN_144; // @[KvRingBuffer.scala 175:28]
  wire [9:0] _GEN_151 = 4'h5 == outputStateReg ? _GEN_65 : readKeyChunkPtr; // @[KvRingBuffer.scala 175:28]
  wire [31:0] _GEN_152 = 4'h5 == outputStateReg ? shadowReg : _GEN_145; // @[KvRingBuffer.scala 173:28 175:28]
  wire [3:0] _GEN_154 = 4'h4 == outputStateReg ? _GEN_62 : _GEN_148; // @[KvRingBuffer.scala 175:28]
  wire  _GEN_155 = 4'h4 == outputStateReg ? _GEN_63 : _GEN_149; // @[KvRingBuffer.scala 175:28]
  wire [9:0] _GEN_156 = 4'h4 == outputStateReg ? _GEN_64 : _GEN_150; // @[KvRingBuffer.scala 175:28]
  wire [9:0] _GEN_157 = 4'h4 == outputStateReg ? _GEN_65 : _GEN_151; // @[KvRingBuffer.scala 175:28]
  wire [31:0] _GEN_158 = 4'h4 == outputStateReg ? _GEN_66 : _GEN_152; // @[KvRingBuffer.scala 175:28]
  wire [31:0] _GEN_160 = 4'h3 == outputStateReg ? mem_data_data : valueLen; // @[KvRingBuffer.scala 175:28 203:22 109:27]
  wire [9:0] _GEN_161 = 4'h3 == outputStateReg ? _GEN_52 : _GEN_156; // @[KvRingBuffer.scala 175:28]
  wire [9:0] _GEN_162 = 4'h3 == outputStateReg ? _GEN_56 : _GEN_157; // @[KvRingBuffer.scala 175:28]
  wire [3:0] _GEN_163 = 4'h3 == outputStateReg ? _GEN_54 : _GEN_154; // @[KvRingBuffer.scala 175:28]
  wire  _GEN_164 = 4'h3 == outputStateReg ? _GEN_33 : _GEN_155; // @[KvRingBuffer.scala 175:28]
  wire [31:0] _GEN_165 = 4'h3 == outputStateReg ? shadowReg : _GEN_158; // @[KvRingBuffer.scala 173:28 175:28]
  wire  _GEN_172 = 4'h2 == outputStateReg ? _GEN_33 : _GEN_164; // @[KvRingBuffer.scala 175:28]
  wire  _GEN_180 = 4'h1 == outputStateReg ? _GEN_33 : _GEN_172; // @[KvRingBuffer.scala 175:28]
  wire  _GEN_188 = 4'h0 == outputStateReg ? _GEN_33 : _GEN_180; // @[KvRingBuffer.scala 175:28]
  wire  _io_deq_valid_T_3 = outputStateReg == 4'h5; // @[KvRingBuffer.scala 351:111]
  wire  _io_deq_valid_T_5 = outputStateReg == 4'h7; // @[KvRingBuffer.scala 351:148]
  wire  _io_deq_valid_T_9 = outputStateReg == 4'ha; // @[KvRingBuffer.scala 351:232]
  wire  _io_deq_valid_T_11 = outputStateReg == 4'h9; // @[KvRingBuffer.scala 351:273]
  wire  _io_deq_valid_T_13 = outputStateReg == 4'hb; // @[KvRingBuffer.scala 351:312]
  assign mem_data_en = 1'h1; // @[KvRingBuffer.scala 172:{24,24} 84:26]
  ...
  assign io_enq_ready = _writeDataPtr_T & _T_8; // @[KvRingBuffer.scala 350:51]
  assign io_deq_valid = outputStateReg == 4'h4 | outputStateReg == 4'h6 | outputStateReg == 4'h5 | outputStateReg == 4'h7
     | outputStateReg == 4'h8 | outputStateReg == 4'ha | outputStateReg == 4'h9 | outputStateReg == 4'hb; // @[KvRingBuffer.scala 351:294]
  assign io_deq_bits = _io_deq_valid_T_3 | _io_deq_valid_T_5 | _io_deq_valid_T_11 | _io_deq_valid_T_13 ? shadowReg :
    mem_data_data; // @[KvRingBuffer.scala 352:23]
  assign io_lastOutput = _io_deq_valid_T_9 | _io_deq_valid_T_13; // @[KvRingBuffer.scala 354:61]
  assign io_metadataValid = outputStateReg == 4'h2 | outputStateReg == 4'h3; // @[KvRingBuffer.scala 358:61]
  always @(posedge clock) begin
    if (mem_data_en) begin
      mem_data_addr <= {{1'd0}, readFullPtr}; // @[KvRingBuffer.scala 172:24]
    end
    ...
    end else if (4'h0 == outputStateReg) begin // @[KvRingBuffer.scala 175:28]
      if (~emptyReg) begin // @[KvRingBuffer.scala 177:54]
        outputStateReg <= 4'h1; // @[KvRingBuffer.scala 180:32]
      end
    end else if (4'h1 == outputStateReg) begin // @[KvRingBuffer.scala 175:28]
      outputStateReg <= 4'h2;
    end else if (4'h2 == outputStateReg) begin // @[KvRingBuffer.scala 175:28]
      outputStateReg <= 4'h3;
    end else begin
    ...
    end else if (2'h0 == inputStateReg) begin // @[KvRingBuffer.scala 131:27]
      if (io_enq_valid & ~fullReg) begin // @[KvRingBuffer.scala 133:44]
        if (!(io_isInputKey)) begin // @[KvRingBuffer.scala 134:38]
          inputStateReg <= _GEN_6;
        end
      end
    end else if (2'h1 == inputStateReg) begin // @[KvRingBuffer.scala 131:27]
      inputStateReg <= 2'h2; // @[KvRingBuffer.scala 147:27]
    end else if (2'h2 == inputStateReg) begin // @[KvRingBuffer.scala 131:27]
      inputStateReg <= 2'h0; // @[KvRingBuffer.scala 157:27]
    end
    if (reset) begin // @[KvRingBuffer.scala 75:29]
      ...
      if (io_enq_valid & ~fullReg) begin // @[KvRingBuffer.scala 133:44]
        if (io_isInputKey) begin // @[KvRingBuffer.scala 134:38]
          writeKeyChunkPtr <= _nextVal_T_8; // @[KvRingBuffer.scala 135:38]
        end
      end
    end else if (!(2'h1 == inputStateReg)) begin // @[KvRingBuffer.scala 131:27]
      if (2'h2 == inputStateReg) begin // @[KvRingBuffer.scala 131:27]
        writeKeyChunkPtr <= 10'h0; // @[KvRingBuffer.scala 158:30]
      end
    end
    if (reset) begin // @[KvRingBuffer.scala 75:29]
      ...
      if (io_enq_valid & ~fullReg) begin // @[KvRingBuffer.scala 133:44]
        if (!(io_isInputKey)) begin // @[KvRingBuffer.scala 134:38]
          writeValueChunkPtr <= _nextVal_T_11; // @[KvRingBuffer.scala 137:40]
        end
      end
    end else if (!(2'h1 == inputStateReg)) begin // @[KvRingBuffer.scala 131:27]
      if (2'h2 == inputStateReg) begin // @[KvRingBuffer.scala 131:27]
        writeValueChunkPtr <= 10'h0; // @[KvRingBuffer.scala 159:32]
      end
    end
    if (reset) begin // @[KvRingBuffer.scala 75:29]
      ...
      if (~emptyReg) begin // @[KvRingBuffer.scala 177:54]
        readKeyChunkPtr <= 10'h0; // @[KvRingBuffer.scala 178:33]
      end
    end else if (4'h1 == outputStateReg) begin // @[KvRingBuffer.scala 175:28]
    ...
    if (reset) begin // @[KvRingBuffer.scala 75:29]
      ...
      if (~emptyReg) begin // @[KvRingBuffer.scala 177:54]
        readValueChunkPtr <= 10'h0; // @[KvRingBuffer.scala 179:35]
      end
    end else if (!(4'h1 == outputStateReg)) begin // @[KvRingBuffer.scala 175:28]
      if (4'h2 == outputStateReg) begin // @[KvRingBuffer.scala 175:28]
    ...
    if (reset) begin // @[KvRingBuffer.scala 108:25]
      ...
      if (!(4'h1 == outputStateReg)) begin // @[KvRingBuffer.scala 175:28]
        if (4'h2 == outputStateReg) begin // @[KvRingBuffer.scala 175:28]
          keyLen <= _GEN_48;
        end
      end
    ...
    if (reset) begin // @[KvRingBuffer.scala 112:26]
      ...
      if (!(2'h1 == inputStateReg)) begin // @[KvRingBuffer.scala 131:27]
        if (2'h2 == inputStateReg) begin // @[KvRingBuffer.scala 131:27]
          fullReg <= nextWrite == readPtr; // @[KvRingBuffer.scala 154:21]
        end
      end
    end
    if (reset) begin // @[KvRingBuffer.scala 124:27]
      ...
      writeReg <= {{22'd0}, writeValueChunkPtr}; // @[KvRingBuffer.scala 148:22]
    end
    if (reset) begin // @[KvRingBuffer.scala 173:28]
      shadowReg <= 32'h0; // @[KvRingBuffer.scala 173:28]
    end else if (!(4'h0 == outputStateReg)) begin // @[KvRingBuffer.scala 175:28]
      if (!(4'h1 == outputStateReg)) begin // @[KvRingBuffer.scala 175:28]
        if (!(4'h2 == outputStateReg)) begin // @[KvRingBuffer.scala 175:28]
          shadowReg <= _GEN_165;
